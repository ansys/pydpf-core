...
# model.plot(color="w", show_edges=True, stitle='Model', text='Model plot')
# # Additional PyVista kwargs are supported, such as:
# model.plot(off_screen=True, screenshot='model_plot.png', stitle='Model', text='Model plot')
...
field = fc[0]
# field.plot(notebook=False, shell_layers=None, show_axes=True, stitle='Field', text='Field plot')
# # Additional PyVista kwargs are supported, such as:
# field.plot(off_screen=True, screenshot='field_plot.png', stitle='Field', text='Field plot off')
#
...
#           stitle='Mesh fc None', text='Mesh plot')
# Additional PyVista kwargs are supported, such as:
# mesh.plot(off_screen=True, screenshot='mesh_plot.png', stitle='Mesh', text='Mesh plot off')
# A fields_container or a specific field can be given to plot on the mesh.
# mesh.plot(field_or_fields_container=fc, stitle='Mesh with fields container', text='Mesh fc plot')
# mesh.plot(field_or_fields_container=field, stitle='Mesh with field', text='Mesh field plot')
#
...
# meshes_cont.plot(stitle='Meshes Container', text='Meshes Container plot')
...
# meshes_cont.plot(disp_fc, stitle='Meshes Container disp_fc', text='Meshes Container disp_fc plot')
# # Additional PyVista kwargs are supported, such as:
# meshes_cont.plot(off_screen=True, screenshot='meshes_cont_plot.png',
#                  stitle='Meshes Container', text='Meshes Container plot')
#
