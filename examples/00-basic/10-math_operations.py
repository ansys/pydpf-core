...
# Accumulate
# ~~~~~~~~~~
# First we define fields, by default fields are 3d dimensional, so one elementary data is a 3d vector
# but the optional ponderation field is a field which takes one value per entity, so we need to change its dimensionality (1d)
num_entities = 3
