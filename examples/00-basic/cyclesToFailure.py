...
xPoints = snData[:,1][::-1] # the x values are the stress ranges and need to be in ascending order
yValues = snData[:,0][::-1] # y values are the cycles to failure (need to be inverted to stay with stress value)
