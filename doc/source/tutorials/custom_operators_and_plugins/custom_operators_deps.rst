...
#. Download the script for your operating system:
   ...
   - For Windows, download this :download:`PowerShell script </tutorials/enriching_dpf_capabilities/create_sites_for_python_operators.ps1>`.
   - For Linux, download this :download:`Shell script </tutorials/enriching_dpf_capabilities/create_sites_for_python_operators.sh>`.
