...
You can enhance and customize your DPF installation by creating new operators and libraries of
operators, called 'plugins'. PyDPF-Core becomes a development tool offering accessible,
componentized, and easily distributable custom operators.
...
.. grid:: 1 1 3 3
    ...
    .. grid-item-card:: Create a DPF plugin with a single operator
       ...
       This tutorial shows how to create, load, and use a custom plugin containing a single
       custom operator.
    ...
    .. grid-item-card:: Create a DPF plugin with multiple operators
        ...
        This tutorial shows how to create, load, and use a custom plugin with multiple operators
        or with complex routines.

        +++
        Coming soon

    .. grid-item-card:: Create a custom DPF plugin with third-party dependencies
        :text-align: center
        :class-header: sd-bg-light sd-text-dark
        :class-footer: sd-bg-light sd-text-dark
