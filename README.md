...
To use PyDPF-Core with the standalone ``ansys-dpf-server`` server package 7.1 or later; or with Ansys 2024 R1 or later, install the latest version with this command:
