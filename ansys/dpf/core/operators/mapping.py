...
class OnCoordinates(dpf.Operator):
    ...
    >>> op = dpf.operators.OnCoordinates(my_fields_container,
                                         my_coordinates,
                                         my_create_support, # optional
                                         my_mapping_on_scoping, # optional
                                         my_mesh)  # optional
    ...
    def __init__(self, fields_container, coordinates, create_support=None, mapping_on_scoping=None, mesh=None, channel=None):
        if channel is None:
...
class SolidToSkin(dpf.Operator):
    ...
    >>> op = dpf.operators.SolidToSkin(my_field,
