...
class coordinates(Operator):
    """Read/compute Coordinates (LSDyna) by calling the readers defined by the datasources.
      ...
      >>> op = dpf.operators.result.coordinates(time_scoping=my_time_scoping,mesh_scoping=my_mesh_scoping,data_sources=my_data_sources)
    ...
    @staticmethod
    def _spec():
        spec = Specification(description="""Read/compute Coordinates (LSDyna) by calling the readers defined by the datasources.""",
                             map_input_pin_spec={
    ...
    @staticmethod
    def default_config():
        return Operator.default_config(name = "X")
...
class InputsCoordinates(_Inputs):
    """Intermediate class used to connect user inputs to coordinates operator
...
class OutputsCoordinates(_Outputs):
    """Intermediate class used to get outputs from coordinates operator
      Examples
      --------
      >>> from ansys.dpf import core as dpf
