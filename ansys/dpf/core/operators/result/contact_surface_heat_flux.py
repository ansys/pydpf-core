...
class contact_surface_heat_flux(Operator):
    """Read/compute element total heat flux at contact surface by calling the readers defined by the datasources.
      ...
      >>> op = dpf.operators.result.contact_surface_heat_flux(time_scoping=my_time_scoping,mesh_scoping=my_mesh_scoping,data_sources=my_data_sources)
    ...
    @staticmethod
    def _spec():
        spec = Specification(description="""Read/compute element total heat flux at contact surface by calling the readers defined by the datasources.""",
                             map_input_pin_spec={
