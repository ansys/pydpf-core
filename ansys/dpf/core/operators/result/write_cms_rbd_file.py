...
class write_cms_rbd_file(Operator):
    """Write the invariant terms and the model data in a cms_rbd file
      ...
      >>> my_master_node_coordinates = dpf.list()
      ...
      >>> op = dpf.operators.result.write_cms_rbd_file(model_data=my_model_data,center_of_mass=my_center_of_mass,inertia_relief=my_inertia_relief,model_size=my_model_size,master_node_coordinates=my_master_node_coordinates,v_trsf=my_v_trsf,k_mat=my_k_mat,mass_mat=my_mass_mat,c_mat=my_c_mat,rhs=my_rhs,dn=my_dn,dr_cross_n=my_dr_cross_n,drn=my_drn,dn_cross_n=my_dn_cross_n,dnx_y=my_dnx_y,dny_y=my_dny_y,dnz_y=my_dnz_y,dyx_n=my_dyx_n,dyy_n=my_dyy_n,dyz_n=my_dyz_n,dnxn=my_dnxn,dnyn=my_dnyn,dnzn=my_dnzn,file_path=my_file_path)

      >>> # Get output data"""
    def __init__(self, model_data=None, center_of_mass=None, inertia_relief=None, model_size=None, master_node_coordinates=None, v_trsf=None, k_mat=None, mass_mat=None, c_mat=None, rhs=None, dn=None, dr_cross_n=None, drn=None, dn_cross_n=None, dnx_y=None, dny_y=None, dnz_y=None, dyx_n=None, dyy_n=None, dyz_n=None, dnxn=None, dnyn=None, dnzn=None, file_path=None, config=None, server=None):
        ...
        if master_node_coordinates !=None:
    ...
    @staticmethod
    def _spec():
        spec = Specification(description="""Write the invariant terms and the model data in a cms_rbd file""",
                             map_input_pin_spec={
                                 ...
                                 3 : PinSpecification(name = "model_size", type_names=["property_field"], optional=False, document="""size of the diagonal box containing the body"""), 
                                 ...
                                 23 : PinSpecification(name = "file_path", type_names=["string"], optional=False, document="""path with cms_rbd extension where the export occurs""")},
                             map_output_pin_spec={
})
        return spec
    ...
    @staticmethod
    def default_config():
        return Operator.default_config(name = "write_cms_rbd_file")
...
class InputsWriteCmsRbdFile(_Inputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._master_node_coordinates = Input(write_cms_rbd_file._spec().input_pin(4), 4, op, -1) 
    ...
    def model_size(self):
        ...
        - pindoc: size of the diagonal box containing the body
    ...
    def file_path(self):
        ...
        - pindoc: path with cms_rbd extension where the export occurs
