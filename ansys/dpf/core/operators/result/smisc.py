...
class smisc(Operator):
    """Read SMISC results from the rst file.
      ...
      >>> op = dpf.operators.result.smisc(time_scoping=my_time_scoping,mesh_scoping=my_mesh_scoping,fields_container=my_fields_container,streams_container=my_streams_container,data_sources=my_data_sources,mesh=my_mesh,item_index=my_item_index,num_components=my_num_components)
