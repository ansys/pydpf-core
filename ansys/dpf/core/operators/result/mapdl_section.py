...
class mapdl_section(Operator):
    """Read the values of the section properties for a given section property field(property field that contains section information for each element of a mesh).The following keys can be used: Thickness, NumLayers
      ...
      >>> op = dpf.operators.result.mapdl_section(properties_name=my_properties_name,section=my_section,streams_container=my_streams_container,data_sources=my_data_sources)

      >>> # Get output data
      >>> result_properties_value = op.outputs.properties_value()"""
    def __init__(self, properties_name=None, section=None, streams_container=None, data_sources=None, config=None, server=None):
    ...
    @staticmethod
    def _spec():
        spec = Specification(description="""Read the values of the section properties for a given section property field(property field that contains section information for each element of a mesh).The following keys can be used: Thickness, NumLayers""",
                             map_input_pin_spec={
                                 0 : PinSpecification(name = "properties_name", type_names=["string"], optional=False, document=""""""), 
                                 1 : PinSpecification(name = "section", type_names=["property_field"], optional=True, document="""Property field that contains a section id per element.(optional)"""), 
    ...
    @staticmethod
    def default_config():
        return Operator.default_config(name = "mapdl_section_properties")
...
class InputsMapdlSection(_Inputs):
    ...
    def section(self):
        ...
        - pindoc: Property field that contains a section id per element.(optional)
...
class OutputsMapdlSection(_Outputs):
    """Intermediate class used to get outputs from mapdl_section operator
      Examples
      --------
      >>> from ansys.dpf import core as dpf
