...
class total_strain(Operator):
    """Read/compute Total strain (LSDyna) by calling the readers defined by the datasources.
      ...
      >>> op = dpf.operators.result.total_strain(time_scoping=my_time_scoping,mesh_scoping=my_mesh_scoping,data_sources=my_data_sources)
    ...
    @staticmethod
    def _spec():
        spec = Specification(description="""Read/compute Total strain (LSDyna) by calling the readers defined by the datasources.""",
                             map_input_pin_spec={
    ...
    @staticmethod
    def default_config():
        return Operator.default_config(name = "EL")
...
class InputsTotalStrain(_Inputs):
    """Intermediate class used to connect user inputs to total_strain operator
    ...
    def __init__(self, op: Operator):
        ...
        self._bool_rotate_to_global = Input(total_strain._spec().input_pin(5), 5, op, -1) 
...
class OutputsTotalStrain(_Outputs):
    """Intermediate class used to get outputs from total_strain operator
      Examples
      --------
      >>> from ansys.dpf import core as dpf
