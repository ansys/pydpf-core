...
class global_velocity(Operator):
    """Read/compute Global Velocity (LSDyna) by calling the readers defined by the datasources. The location will be overall (global result).
      ...
      >>> op = dpf.operators.result.global_velocity(time_scoping=my_time_scoping,data_sources=my_data_sources)
    ...
    @staticmethod
    def _spec():
        spec = Specification(description="""Read/compute Global Velocity (LSDyna) by calling the readers defined by the datasources. The location will be overall (global result).""",
                             map_input_pin_spec={
    ...
    @staticmethod
    def default_config():
        return Operator.default_config(name = "GLOB_V")
...
class InputsGlobalVelocity(_Inputs):
    """Intermediate class used to connect user inputs to global_velocity operator
...
class OutputsGlobalVelocity(_Outputs):
    """Intermediate class used to get outputs from global_velocity operator
      Examples
      --------
      >>> from ansys.dpf import core as dpf
