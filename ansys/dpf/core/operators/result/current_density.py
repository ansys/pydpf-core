...
class current_density(Operator):
    """Read/compute Current Density by calling the readers defined by the datasources.
      ...
      >>> op = dpf.operators.result.current_density(time_scoping=my_time_scoping,mesh_scoping=my_mesh_scoping,data_sources=my_data_sources)
    ...
    @staticmethod
    def _spec():
        spec = Specification(description="""Read/compute Current Density by calling the readers defined by the datasources.""",
                             map_input_pin_spec={
    ...
    @staticmethod
    def default_config():
        return Operator.default_config(name = "ECD")
...
class InputsCurrentDensity(_Inputs):
    """Intermediate class used to connect user inputs to current_density operator
    ...
    def __init__(self, op: Operator):
        ...
        self._bool_rotate_to_global = Input(current_density._spec().input_pin(5), 5, op, -1) 
...
class OutputsCurrentDensity(_Outputs):
    """Intermediate class used to get outputs from current_density operator
      Examples
      --------
      >>> from ansys.dpf import core as dpf
