...
class coordinate_system(Operator):
    """Extracts the Rotation Matrix and Origin of a specific coordinate system
      ...
      >>> op = dpf.operators.result.coordinate_system(cs_id=my_cs_id,streams_container=my_streams_container,data_sources=my_data_sources)

      >>> # Get output data
      >>> result_field = op.outputs.field()"""
    def __init__(self, cs_id=None, streams_container=None, data_sources=None, config=None, server=None):
    ...
    @staticmethod
    def _spec():
        spec = Specification(description="""Extracts the Rotation Matrix and Origin of a specific coordinate system""",
                             map_input_pin_spec={
                                 0 : PinSpecification(name = "cs_id", type_names=["int32"], optional=False, document=""""""), 
                             ...
                             map_output_pin_spec={
                                 0 : PinSpecification(name = "field", type_names=["field"], optional=False, document="""the first 9 double are the rotation (3x3 matrix) and the last 3 is the translation vector""")})
        return spec


    @staticmethod
    def default_config():
        return Operator.default_config(name = "mapdl::rst::CS")
...
class InputsCoordinateSystem(_Inputs):
    """Intermediate class used to connect user inputs to coordinate_system operator
    ...
    def __init__(self, op: Operator):
        ...
        self._streams_container = Input(coordinate_system._spec().input_pin(3), 3, op, -1) 
...
class OutputsCoordinateSystem(_Outputs):
    """Intermediate class used to get outputs from coordinate_system operator
      Examples
      --------
      >>> from ansys.dpf import core as dpf
    ...
    def field(self):
        ...
        - pindoc: the first 9 double are the rotation (3x3 matrix) and the last 3 is the translation vector
