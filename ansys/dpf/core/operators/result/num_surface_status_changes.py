...
class num_surface_status_changes(Operator):
    """Read/compute element total number of contact status changes during substep by calling the readers defined by the datasources.
      ...
      >>> op = dpf.operators.result.num_surface_status_changes(time_scoping=my_time_scoping,mesh_scoping=my_mesh_scoping,data_sources=my_data_sources)
    ...
    @staticmethod
    def _spec():
        spec = Specification(description="""Read/compute element total number of contact status changes during substep by calling the readers defined by the datasources.""",
                             map_input_pin_spec={
