...
class total_mass(Operator):
    """Reads total mass from mode file.
      ...
      >>> op = dpf.operators.result.total_mass(data_sources=my_data_sources)
    ...
    @staticmethod
    def _spec():
        spec = Specification(description="""Reads total mass from mode file.""",
                             map_input_pin_spec={
                                 4 : PinSpecification(name = "data_sources", type_names=["data_sources"], optional=False, document="""Data sources (must contain at least one mode file).""")},
                             map_output_pin_spec={
                                 0 : PinSpecification(name = "mass", type_names=["double"], optional=False, document="""the unit should be grabbed from the rst file""")})
        return spec


    @staticmethod
    def default_config():
        return Operator.default_config(name = "mapdl::mode::total_mass")
...
class InputsTotalMass(_Inputs):
    ...
    def data_sources(self):
        ...
        - pindoc: Data sources (must contain at least one mode file).
...
class OutputsTotalMass(_Outputs):
    """Intermediate class used to get outputs from total_mass operator
      Examples
      --------
      >>> from ansys.dpf import core as dpf
    ...
    def mass(self):
        ...
        - pindoc: the unit should be grabbed from the rst file
