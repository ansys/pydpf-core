...
class pressure(Operator):
    """Read/compute Pressure by calling the readers defined by the datasources.
      ...
      >>> op = dpf.operators.result.pressure(time_scoping=my_time_scoping,mesh_scoping=my_mesh_scoping,data_sources=my_data_sources)
    ...
    @staticmethod
    def _spec():
        spec = Specification(description="""Read/compute Pressure by calling the readers defined by the datasources.""",
                             map_input_pin_spec={
    ...
    @staticmethod
    def default_config():
        return Operator.default_config(name = "Pressure")
...
class InputsPressure(_Inputs):
    """Intermediate class used to connect user inputs to pressure operator
...
class OutputsPressure(_Outputs):
    """Intermediate class used to get outputs from pressure operator
      Examples
      --------
      >>> from ansys.dpf import core as dpf
