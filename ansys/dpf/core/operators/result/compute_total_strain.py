...
""",
    ...
    @staticmethod
    def default_config():
        return Operator.default_config(name = "compute_total_strain")
...
class InputsComputeTotalStrain(_Inputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._streams_container = Input(compute_total_strain._spec().input_pin(3), 3, op, -1) 
        ...
        self._meshed_region = Input(compute_total_strain._spec().input_pin(7), 7, op, -1) 
        self._inputs.append(self._meshed_region)
        self._requested_location = Input(compute_total_strain._spec().input_pin(9), 9, op, -1) 
        self._inputs.append(self._requested_location)
        self._displacement = Input(compute_total_strain._spec().input_pin(10), 10, op, -1) 
