...
class remove_rigid_body_motion(Operator):
    ...
    @staticmethod
    def _spec():
        spec = Specification(description="""Removes rigid body mode from a total displacement field by minimization. Use a reference point in order to subtract its displacement to the result displacement field.""",
                             map_input_pin_spec={
