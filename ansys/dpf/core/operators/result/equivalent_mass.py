...
class equivalent_mass(Operator):
    """Read/compute equivalent dof mass by calling the readers defined by the datasources.
      ...
      >>> op = dpf.operators.result.equivalent_mass(time_scoping=my_time_scoping,mesh_scoping=my_mesh_scoping,data_sources=my_data_sources)
    ...
    @staticmethod
    def _spec():
        spec = Specification(description="""Read/compute equivalent dof mass by calling the readers defined by the datasources.""",
                             map_input_pin_spec={
    ...
    @staticmethod
    def default_config():
        return Operator.default_config(name = "equivalent_mass")
...
class InputsEquivalentMass(_Inputs):
    """Intermediate class used to connect user inputs to equivalent_mass operator
    ...
    def __init__(self, op: Operator):
        ...
        self._bool_rotate_to_global = Input(equivalent_mass._spec().input_pin(5), 5, op, -1) 
...
class OutputsEquivalentMass(_Outputs):
    """Intermediate class used to get outputs from equivalent_mass operator
      Examples
      --------
      >>> from ansys.dpf import core as dpf
