...
class add_rigid_body_motion_fc(Operator):
    ...
    @staticmethod
    def _spec():
        spec = Specification(description="""Adds a given rigid translation, center and rotation from a displacement field. The rotation is given in terms of rotations angles. Note that the displacement field has to be in the global coordinate system""",
                             map_input_pin_spec={
