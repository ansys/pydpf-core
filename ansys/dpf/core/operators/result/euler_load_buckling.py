...
class euler_load_buckling(Operator):
    """Computing Euler's Critical Load. Formula: Ncr = n*E*I*pi*pi /(L*L) 
      ...
      available inputs:
        - field_beam_end_condition (DataSources, Field)
      ...
      >>> op = dpf.operators.result.euler_load_buckling(field_beam_end_condition=my_field_beam_end_condition,field_beam_moment_inertia=my_field_beam_moment_inertia,field_beam_young_modulus=my_field_beam_young_modulus,field_beam_length=my_field_beam_length)
    ...
    def __init__(self, field_beam_end_condition=None, field_beam_moment_inertia=None, field_beam_young_modulus=None, field_beam_length=None, config=None, server=None):
        ...
        if field_beam_end_condition !=None:
            self.inputs.field_beam_end_condition.connect(field_beam_end_condition)
        if field_beam_moment_inertia !=None:
            self.inputs.field_beam_moment_inertia.connect(field_beam_moment_inertia)
        if field_beam_young_modulus !=None:
            self.inputs.field_beam_young_modulus.connect(field_beam_young_modulus)
        if field_beam_length !=None:
            self.inputs.field_beam_length.connect(field_beam_length)

    @staticmethod
    def _spec():
        spec = Specification(description="""Computing Euler's Critical Load. Formula: Ncr = n*E*I*pi*pi /(L*L) """,
                             map_input_pin_spec={
                                 5 : PinSpecification(name = "field_beam_end_condition", type_names=["data_sources","field"], optional=False, document="""This pin contains file csv or field of beam's end condition added by the user. If there's no file added, it would take value of all beam's end condition as 1."""), 
                                 6 : PinSpecification(name = "field_beam_moment_inertia", type_names=["field"], optional=False, document="""Field of beam's moment inertia"""), 
                                 7 : PinSpecification(name = "field_beam_young_modulus", type_names=["field"], optional=False, document="""Field of beam's young modulus"""), 
                                 8 : PinSpecification(name = "field_beam_length", type_names=["field"], optional=False, document="""Field of beam's length""")},
                             map_output_pin_spec={
                                 0 : PinSpecification(name = "field_euler_critical_load", type_names=["field"], optional=False, document="""This field contains Euler's Critical Load about the principle axis of the cross section having the least moment of inertia."""), 
                                 1 : PinSpecification(name = "field_euler_critical_load_yy", type_names=["field"], optional=False, document="""This field contains Euler's Critical Load on axis y."""), 
                                 2 : PinSpecification(name = "field_euler_critical_load_zz", type_names=["field"], optional=False, document="""This field contains Euler's Critical Load on axis z.""")})
        return spec


    @staticmethod
    def default_config():
        return Operator.default_config(name = "euler_load_buckling")
...
class InputsEulerLoadBuckling(_Inputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._field_beam_end_condition = Input(euler_load_buckling._spec().input_pin(5), 5, op, -1) 
        self._inputs.append(self._field_beam_end_condition)
        self._field_beam_moment_inertia = Input(euler_load_buckling._spec().input_pin(6), 6, op, -1) 
        self._inputs.append(self._field_beam_moment_inertia)
        self._field_beam_young_modulus = Input(euler_load_buckling._spec().input_pin(7), 7, op, -1) 
        self._inputs.append(self._field_beam_young_modulus)
        self._field_beam_length = Input(euler_load_buckling._spec().input_pin(8), 8, op, -1) 
    ...
    def field_beam_end_condition(self):
        ...
        - pindoc: This pin contains file csv or field of beam's end condition added by the user. If there's no file added, it would take value of all beam's end condition as 1.

        Parameters
        ----------
        my_field_beam_end_condition : DataSources, Field, 
    ...
    def field_beam_moment_inertia(self):
        ...
        - pindoc: Field of beam's moment inertia
    ...
    def field_beam_young_modulus(self):
        ...
        - pindoc: Field of beam's young modulus
...
class OutputsEulerLoadBuckling(_Outputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._field_euler_critical_load_yy = Output(euler_load_buckling._spec().output_pin(1), 1, op) 
        self._outputs.append(self._field_euler_critical_load_yy)
        self._field_euler_critical_load_zz = Output(euler_load_buckling._spec().output_pin(2), 2, op) 
    ...
    def field_euler_critical_load(self):
        ...
        - pindoc: This field contains Euler's Critical Load about the principle axis of the cross section having the least moment of inertia.
    ...
    def field_euler_critical_load_yy(self):
        ...
        - pindoc: This field contains Euler's Critical Load on axis y.
    ...
    def field_euler_critical_load_zz(self):
        ...
        - pindoc: This field contains Euler's Critical Load on axis z.
