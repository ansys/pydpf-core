...
class nodal_extend_to_mid_nodes(Operator):
    """Extends a Nodal field defined on corner nodes to a field defined also on mid nodes.
      ...
      >>> op = dpf.operators.averaging.nodal_extend_to_mid_nodes(field=my_field,node_scoping=my_node_scoping,element_scoping=my_element_scoping,mesh=my_mesh)

      >>> # Get output data
      >>> result_field = op.outputs.field()"""
    def __init__(self, field=None, node_scoping=None, element_scoping=None, mesh=None, config=None, server=None):
    ...
    @staticmethod
    def _spec():
        spec = Specification(description="""Extends a Nodal field defined on corner nodes to a field defined also on mid nodes.""",
                             map_input_pin_spec={
                                 ...
                                 1 : PinSpecification(name = "node_scoping", type_names=["scoping"], optional=True, document="""Nodes expected in output."""), 
                                 5 : PinSpecification(name = "element_scoping", type_names=["scoping"], optional=True, document="""Precomputed list of elements of interest (improves performances)."""), 
    ...
    @staticmethod
    def default_config():
        return Operator.default_config(name = "nodal_extend_to_mid_nodes")
...
class InputsNodalExtendToMidNodes(_Inputs):
    """Intermediate class used to connect user inputs to nodal_extend_to_mid_nodes operator
    ...
    def __init__(self, op: Operator):
        ...
        self._node_scoping = Input(nodal_extend_to_mid_nodes._spec().input_pin(1), 1, op, -1) 
        self._inputs.append(self._node_scoping)
        self._element_scoping = Input(nodal_extend_to_mid_nodes._spec().input_pin(5), 5, op, -1) 
    ...
    def node_scoping(self):
        ...
        - pindoc: Nodes expected in output.
    ...
    def element_scoping(self):
        ...
        - pindoc: Precomputed list of elements of interest (improves performances).
...
class OutputsNodalExtendToMidNodes(_Outputs):
    """Intermediate class used to get outputs from nodal_extend_to_mid_nodes operator
      Examples
      --------
      >>> from ansys.dpf import core as dpf
