...
class OnProperty(dpf.Operator):
    ...
    >>> op = dpf.operators.OnProperty(my_requested_location,
                                      my_property_name,
                                      my_property_id,
                                      my_data_sources,
                                      my_streams_container, # optional
                                      my_inclusive)  # optional
    >>> my_mesh_scoping = op.mesh_scoping
    ...
    def __init__(self, requested_location, property_name, property_id, data_sources, streams_container=None, inclusive=None, channel=None):
        if channel is None:
...
class Transpose(dpf.Operator):
    ...
    >>> op = dpf.operators.Transpose(my_mesh_scoping,
                                     my_meshed_region,
                                     my_inclusive)  # optional
    >>> my_mesh_scoping = op.mesh_scoping
    ...
    def __init__(self, mesh_scoping, meshed_region, inclusive=None, channel=None):
        if channel is None:
            channel = dpf.server._global_channel()
...
class SplittedOnPropertyType(dpf.Operator):
    ...
    >>> op = dpf.operators.SplittedOnPropertyType(my_mesh,
    ...
    def __init__(self, mesh, requested_location, mesh_scoping=None, label=None, channel=None):
        if channel is None:
            channel = dpf.server._global_channel()
...
class OnNamedSelection(dpf.Operator):
    ...
    >>> op = dpf.operators.OnNamedSelection(my_requested_location,
                                            my_named_selection_name,
                                            my_data_sources,
                                            my_int_inclusive, # optional
                                            my_streams_container)  # optional
    >>> my_mesh_scoping = op.mesh_scoping
    ...
    def __init__(self, requested_location, named_selection_name, data_sources, int_inclusive=None, streams_container=None, channel=None):
        if channel is None:
            channel = dpf.server._global_channel()
...
class ConnectivityIds(dpf.Operator):
    ...
    >>> op = dpf.operators.ConnectivityIds(my_mesh_scoping,
                                           my_mesh, # optional
                                           my_take_mid_nodes)  # optional
    >>> my_elemental_scoping = op.elemental_scoping
    >>> my_mesh_scoping = op.mesh_scoping
    ...
    def __init__(self, mesh_scoping, mesh=None, take_mid_nodes=None, channel=None):
        if channel is None:
            channel = dpf.server._global_channel()
...
class FromMesh(dpf.Operator):
    ...
    >>> op = dpf.operators.FromMesh(my_mesh,
                                    my_requested_location)  # optional
    >>> my_scoping = op.scoping
    ...
    def __init__(self, mesh, requested_location=None, channel=None):
        if channel is None:
            channel = dpf.server._global_channel()
