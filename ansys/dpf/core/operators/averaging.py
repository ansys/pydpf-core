...
class ElementalFractionFc(dpf.Operator):
    ...
    def __init__(self, fields_container, mesh=None, scoping=None, denominator=None, collapse_shell_layers=None):
        if channel is None:
...
class ExtendToMidNodesFc(dpf.Operator):
    ...
    def __init__(self, fields_container, mesh=None):
        if channel is None:
            channel = dpf.server._global_channel()
...
class ElementalNodalToNodalElementalFc(dpf.Operator):
    ...
    def __init__(self, fields_container, mesh_scoping=None):
        if channel is None:
            channel = dpf.server._global_channel()
...
class ToElementalFc(dpf.Operator):
    ...
    def __init__(self, fields_container, mesh=None, mesh_scoping=None, smoothen_values=None, collapse_shell_layers=None):
        if channel is None:
            channel = dpf.server._global_channel()
...
class ElementalNodalToNodal(dpf.Operator):
    ...
    def __init__(self, field, mesh, mesh_scoping, should_average=None, through_layers=None):
        if channel is None:
            channel = dpf.server._global_channel()
...
class ElementalNodalToNodalFc(dpf.Operator):
    ...
    def __init__(self, fields_container, mesh=None, should_average=None, scoping=None):
        if channel is None:
            channel = dpf.server._global_channel()
...
class ElementalToNodal(dpf.Operator):
    ...
    def __init__(self, field, mesh_scoping=None, force_averaging=None):
        if channel is None:
            channel = dpf.server._global_channel()
...
class ElementalToNodalFc(dpf.Operator):
    ...
    def __init__(self, fields_container, mesh_scoping=None, force_averaging=None):
        if channel is None:
            channel = dpf.server._global_channel()
...
class NodalDifferenceFc(dpf.Operator):
    ...
    def __init__(self, fields_container, mesh=None, scoping=None):
        if channel is None:
            channel = dpf.server._global_channel()
...
class ElementalDifferenceFc(dpf.Operator):
    ...
    def __init__(self, fields_container, mesh=None, scoping=None, collapse_shell_layers=None):
        if channel is None:
            channel = dpf.server._global_channel()
...
class NodalFractionFc(dpf.Operator):
    ...
    def __init__(self, fields_container, mesh=None, scoping=None, denominator=None):
        if channel is None:
            channel = dpf.server._global_channel()
...
class ToNodalFc(dpf.Operator):
    ...
    def __init__(self, fields_container, mesh=None, mesh_scoping=None):
        if channel is None:
            channel = dpf.server._global_channel()
...
class ExtendToMidNodes(dpf.Operator):
    """DPF "extend_to_mid_nodes" Operator
    ...
    Examples
    --------
    >>> op = dpf.operators.ExtendToMidNodes()
    >>> op.inputs.field.connect(my_field)
    >>> my_field = op.outputs.field()
    """
...
class ElementalMean(dpf.Operator):
    ...
    def __init__(self, field, collapse_shell_layers=None, force_averaging=None, scoping=None):
        if channel is None:
            channel = dpf.server._global_channel()
...
class ElementalMeanFc(dpf.Operator):
    ...
    def __init__(self, fields_container, collapse_shell_layers=None, force_averaging=None, scoping=None, abstract_meshed_region=None):
        if channel is None:
            channel = dpf.server._global_channel()
...
class NodalToElemental(dpf.Operator):
    ...
    def __init__(self, field, mesh_scoping=None, collapse_shell_layers=None):
        if channel is None:
            channel = dpf.server._global_channel()
