...
class ResultInfoProvider(dpf.Operator):
    ...
    >>> op = dpf.operators.ResultInfoProvider(my_data_sources,
                                              my_streams_container)  # optional
    >>> my_result_info = op.result_info
...
class TimeFreqProvider(dpf.Operator):
    ...
    >>> op = dpf.operators.TimeFreqProvider(my_data_sources,
                                            my_streams_container)  # optional
    >>> my_time_freq_support = op.time_freq_support
...
class MaterialProvider(dpf.Operator):
    ...
    >>> op = dpf.operators.MaterialProvider(my_data_sources,
                                            my_streams_container)  # optional
    >>> my_materials = op.materials
...
class MeshSelectionManagerProvider(dpf.Operator):
    ...
    >>> op = dpf.operators.MeshSelectionManagerProvider(my_data_sources,
                                                        my_streams_container)  # optional
    >>> my_mesh_selection_manager = op.mesh_selection_manager
...
class BoundaryConditionProvider(dpf.Operator):
    ...
    >>> op = dpf.operators.BoundaryConditionProvider(my_data_sources,
                                                     my_streams_container)  # optional
    >>> my_results_info = op.results_info
...
class IsCyclic(dpf.Operator):
    ...
    >>> op = dpf.operators.IsCyclic(my_data_sources,
                                    my_streams_container)  # optional
    >>> my_file_path = op.file_path
...
class CyclicSupportProvider(dpf.Operator):
    ...
    >>> op = dpf.operators.CyclicSupportProvider(my_data_sources,
                                                 my_streams_container, # optional
    ...
    >>> my_sector_meshed_region = op.sector_meshed_region
    ...
    def __init__(self, data_sources, streams_container=None, sector_meshed_region=None, expanded_meshed_region=None, sectors_to_expand=None, channel=None):
        if channel is None:
            channel = dpf.server._global_channel()
