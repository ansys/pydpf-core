...
class migrate_to_vtu(Operator):
    """Extract all results from a datasources and exports them into vtu format. All the connected inputs are forwarded to the result providers operators.
      ...
      >>> op = dpf.operators.serialization.migrate_to_vtu(time_scoping=my_time_scoping,streams_container=my_streams_container,data_sources=my_data_sources,directory=my_directory,base_name=my_base_name,result1=my_result1,result2=my_result2,write_mode=my_write_mode)

      >>> # Get output data
      >>> result_path = op.outputs.path()"""
    def __init__(self, time_scoping=None, streams_container=None, data_sources=None, directory=None, base_name=None, result1=None, result2=None, write_mode=None, config=None, server=None):
    ...
    @staticmethod
    def _spec():
        spec = Specification(description="""Extract all results from a datasources and exports them into vtu format. All the connected inputs are forwarded to the result providers operators.""",
                             map_input_pin_spec={
                                 0 : PinSpecification(name = "time_scoping", type_names=["scoping","vector<int32>"], optional=True, document="""time sets to export, default is all"""), 
                                 ...
                                 20 : PinSpecification(name = "directory", type_names=["string"], optional=False, document="""directory path"""), 
                                 21 : PinSpecification(name = "base_name", type_names=["string"], optional=True, document="""vtu base file name, (default is file)"""), 
                                 30 : PinSpecification(name = "result", type_names=["string"], optional=True, document="""if Operator's names are connected to this Pin, only these results are exported (else all available results are exported)"""), 
                                 31 : PinSpecification(name = "result", type_names=["string"], optional=True, document="""if Operator's names are connected to this Pin, only these results are exported (else all available results are exported)"""), 
                                 100 : PinSpecification(name = "write_mode", type_names=["string"], optional=True, document="""Available are rawbinarycompressed, rawbinary, base64appended, base64inline, ascii, default is (rawbinarycompressed)""")},
                             map_output_pin_spec={
                                 0 : PinSpecification(name = "path", type_names=["data_sources"], optional=False, document="""list of output vtu file path""")})
        return spec


    @staticmethod
    def default_config():
        return Operator.default_config(name = "migrate_to_vtu")
...
class InputsMigrateToVtu(_Inputs):
    """Intermediate class used to connect user inputs to migrate_to_vtu operator
    ...
    def time_scoping(self):
        ...
        - pindoc: time sets to export, default is all
    ...
    def base_name(self):
        ...
        - pindoc: vtu base file name, (default is file)
    ...
    def result1(self):
        ...
        - pindoc: if Operator's names are connected to this Pin, only these results are exported (else all available results are exported)
    ...
    def write_mode(self):
        ...
        - pindoc: Available are rawbinarycompressed, rawbinary, base64appended, base64inline, ascii, default is (rawbinarycompressed)
...
class OutputsMigrateToVtu(_Outputs):
    """Intermediate class used to get outputs from migrate_to_vtu operator
      Examples
      --------
      >>> from ansys.dpf import core as dpf
    ...
    def path(self):
        ...
        - pindoc: list of output vtu file path
