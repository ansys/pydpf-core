...
class import_symbolic_workflow(Operator):
    """Reads a file or string holding a Symbolic Workflow and instantiate a WorkFlow with its data.
      ...
      available inputs:
        - string_or_path (str, DataSources)
        - format (int) (optional)
      ...
      >>> op = dpf.operators.serialization.import_symbolic_workflow(string_or_path=my_string_or_path,format=my_format)
    ...
    @staticmethod
    def _spec():
        spec = Specification(description="""Reads a file or string holding a Symbolic Workflow and instantiate a WorkFlow with its data.""",
                             map_input_pin_spec={
                                 0 : PinSpecification(name = "string_or_path", type_names=["string","data_sources"], optional=False, document=""""""), 
    ...
    @staticmethod
    def default_config():
        return Operator.default_config(name = "import_symbolic_workflow")
...
class InputsImportSymbolicWorkflow(_Inputs):
    """Intermediate class used to connect user inputs to import_symbolic_workflow operator
    ...
    def __init__(self, op: Operator):
        ...
        self._string_or_path = Input(import_symbolic_workflow._spec().input_pin(0), 0, op, -1) 
    ...
    def string_or_path(self):
        ...
        Parameters
        ----------
        my_string_or_path : str, DataSources, 
...
class OutputsImportSymbolicWorkflow(_Outputs):
    """Intermediate class used to get outputs from import_symbolic_workflow operator
      Examples
      --------
      >>> from ansys.dpf import core as dpf
