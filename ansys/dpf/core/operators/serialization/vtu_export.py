...
class vtu_export(Operator):
    """Export DPF data into vtu format.
      ...
      >>> op = dpf.operators.serialization.vtu_export(directory=my_directory,base_name=my_base_name,mesh=my_mesh,fields1=my_fields1,fields2=my_fields2,write_mode=my_write_mode)

      >>> # Get output data
      >>> result_path = op.outputs.path()"""
    def __init__(self, directory=None, base_name=None, mesh=None, fields1=None, fields2=None, write_mode=None, config=None, server=None):
    ...
    @staticmethod
    def _spec():
        spec = Specification(description="""Export DPF data into vtu format.""",
                             map_input_pin_spec={
                                 0 : PinSpecification(name = "directory", type_names=["string"], optional=False, document="""directory path"""), 
                                 1 : PinSpecification(name = "base_name", type_names=["string"], optional=True, document="""vtu base file name, (default is file)"""), 
                                 2 : PinSpecification(name = "mesh", type_names=["abstract_meshed_region"], optional=False, document="""mesh"""), 
                                 3 : PinSpecification(name = "fields", type_names=["field","fields_container"], optional=False, document="""Nodal or Elemental fields (over time) to export"""), 
                                 4 : PinSpecification(name = "fields", type_names=["field","fields_container"], optional=False, document="""Nodal or Elemental fields (over time) to export"""), 
    ...
    @staticmethod
    def default_config():
        return Operator.default_config(name = "vtu_export")
...
class InputsVtuExport(_Inputs):
    ...
    def fields1(self):
        ...
        - pindoc: Nodal or Elemental fields (over time) to export
