...
class txt_to_data_tree(Operator):
    """Reads a txt file or string to a DataTree
      ...
      >>> op = dpf.operators.serialization.txt_to_data_tree(string_or_path=my_string_or_path)
    ...
    @staticmethod
    def _spec():
        spec = Specification(description="""Reads a txt file or string to a DataTree""",
                             map_input_pin_spec={
    ...
    @staticmethod
    def default_config():
        return Operator.default_config(name = "txt_to_data_tree")
...
class InputsTxtToDataTree(_Inputs):
    """Intermediate class used to connect user inputs to txt_to_data_tree operator
...
class OutputsTxtToDataTree(_Outputs):
    """Intermediate class used to get outputs from txt_to_data_tree operator
      Examples
      --------
      >>> from ansys.dpf import core as dpf
