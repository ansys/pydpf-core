...
class vtk_export(Operator):
    """Write the input field and fields container into a given vtk path
      ...
      >>> op = dpf.operators.serialization.vtk_export(export_type=my_export_type,file_path=my_file_path,mesh=my_mesh,fields1=my_fields1,fields2=my_fields2)

      >>> # Get output data"""
    def __init__(self, export_type=None, file_path=None, mesh=None, fields1=None, fields2=None, config=None, server=None):
    ...
    def _spec():
        spec = Specification(description="""Write the input field and fields container into a given vtk path""",
                             map_input_pin_spec={
                                 -1 : PinSpecification(name = "export_type", type_names=["int32"], optional=True, document="""Either export volume elements in the mesh with their fields with value 0 or faces elements in the mesh with their fields with value 1 (default is 0)"""), 
...
class InputsVtkExport(_Inputs):
    ...
    def export_type(self):
        ...
        - pindoc: Either export volume elements in the mesh with their fields with value 0 or faces elements in the mesh with their fields with value 1 (default is 0)
