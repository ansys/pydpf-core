...
class MinMaxInc(dpf.Operator):
    ...
    class _Inputs(dpf.inputs.Inputs):
        ...
        # fmt: off
        _spec = OrderedDict([(0, InputSpec(document='', ellipsis=False, name='field', optional=False, type_names=['field'])), (17, InputSpec(document='', ellipsis=False, name='domain_id', optional=True, type_names=['int32']))]) # noqa: E501
        # fmt: on
    ...
    class _Outputs(dpf.outputs.Outputs):
        ...
        # fmt: off
        _spec = OrderedDict([(0, OutputSpec(name='field_min', type_names=['field'], document='')), (1, OutputSpec(name='field_max', type_names=['field'], document='')), (2, OutputSpec(name='domain_ids_min', type_names=['scoping'], document='')), (3, OutputSpec(name='domain_ids_max', type_names=['scoping'], document=''))]) # noqa: E501
        # fmt: on
