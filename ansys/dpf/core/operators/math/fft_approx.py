...
class fft_approx(Operator):
    """Computes the fitting curve using FFT filtering and cubic fitting in space (node i: x=time, y=data), with possibility to compute the first and the second derivatives of the curve.
      ...
      >>> op = dpf.operators.math.fft_approx(time_scoping=my_time_scoping,mesh_scoping=my_mesh_scoping,entity_to_fit=my_entity_to_fit,component_number=my_component_number,first_derivative=my_first_derivative,second_derivative=my_second_derivative,fit_data=my_fit_data)
    ...
    def __init__(self, time_scoping=None, mesh_scoping=None, entity_to_fit=None, component_number=None, first_derivative=None, second_derivative=None, fit_data=None, config=None, server=None):
    ...
    @staticmethod
    def _spec():
        spec = Specification(description="""Computes the fitting curve using FFT filtering and cubic fitting in space (node i: x=time, y=data), with possibility to compute the first and the second derivatives of the curve.
""",
                             map_input_pin_spec={
                                 0 : PinSpecification(name = "time_scoping", type_names=["vector<int32>","scoping"], optional=True, document="""a time scoping to rescope / split an iunput fields container"""), 
                                 1 : PinSpecification(name = "mesh_scoping", type_names=["scoping","scopings_container"], optional=True, document="""a space (mesh entities) scopings (or container) to rescope / split an input fields container"""), 
                                 2 : PinSpecification(name = "entity_to_fit", type_names=["fields_container"], optional=False, document="""Data changing in time to be fitted"""), 
                                 3 : PinSpecification(name = "component_number", type_names=["int32"], optional=False, document="""component number as an int, ex '0' for X-displacement, '1' for Y-displacement,..."""), 
                                 4 : PinSpecification(name = "first_derivative", type_names=["bool"], optional=False, document="""Calculate the first derivative? (bool): default is false"""), 
                                 5 : PinSpecification(name = "second_derivative", type_names=["bool"], optional=False, document="""Calculate the second derivative? (bool): default is false"""), 
                                 6 : PinSpecification(name = "fit_data", type_names=["bool"], optional=False, document="""Calculate the fitted values? (bool): default is false""")},
                             map_output_pin_spec={
                                 0 : PinSpecification(name = "fitted_entity_y", type_names=["fields_container"], optional=False, document="""the fitted entity is fitted using FFT along the space scoping (node i: x=time, y=data): fitted Y is expected to be close to the input data"""), 
                                 1 : PinSpecification(name = "first_der_dy", type_names=["fields_container"], optional=False, document="""the first derivative (dY) from the fitted Y"""), 
                                 2 : PinSpecification(name = "second_der_d2y", type_names=["fields_container"], optional=False, document="""the second derivative (d2Y) from the fitted Y""")})
        return spec
...
class InputsFftApprox(_Inputs):
    ...
    def time_scoping(self):
        ...
        - pindoc: a time scoping to rescope / split an iunput fields container
    ...
    def mesh_scoping(self):
        ...
        - pindoc: a space (mesh entities) scopings (or container) to rescope / split an input fields container
    ...
    def entity_to_fit(self):
        ...
        - pindoc: Data changing in time to be fitted
    ...
    def component_number(self):
        ...
        - pindoc: component number as an int, ex '0' for X-displacement, '1' for Y-displacement,...
    ...
    def first_derivative(self):
        ...
        - pindoc: Calculate the first derivative? (bool): default is false
    ...
    def second_derivative(self):
        ...
        - pindoc: Calculate the second derivative? (bool): default is false
    ...
    def fit_data(self):
        ...
        - pindoc: Calculate the fitted values? (bool): default is false
...
class OutputsFftApprox(_Outputs):
    ...
    def fitted_entity_y(self):
        ...
        - pindoc: the fitted entity is fitted using FFT along the space scoping (node i: x=time, y=data): fitted Y is expected to be close to the input data
    ...
    def first_der_dy(self):
        ...
        - pindoc: the first derivative (dY) from the fitted Y
    ...
    def second_der_d2y(self):
        ...
        - pindoc: the second derivative (d2Y) from the fitted Y
