...
class outer_product(Operator):
    """Computes the outer product of two vector fields
      ...
      >>> op = dpf.operators.math.outer_product(fieldA=my_fieldA,fieldB=my_fieldB)
    ...
    @staticmethod
    def _spec():
        spec = Specification(description="""Computes the outer product of two vector fields""",
                             map_input_pin_spec={
    ...
    @staticmethod
    def default_config():
        return Operator.default_config(name = "outer_product")
...
class InputsOuterProduct(_Inputs):
    """Intermediate class used to connect user inputs to outer_product operator
...
class OutputsOuterProduct(_Outputs):
    """Intermediate class used to get outputs from outer_product operator
      Examples
      --------
      >>> from ansys.dpf import core as dpf
