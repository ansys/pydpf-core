    ...
    def _spec():
        spec = Specification(description="""Convert an input field/fields container or mesh of a given unit to another unit.""",
                             map_input_pin_spec={
                                 ...
                                 1 : PinSpecification(name = "unit_name", type_names=["string","int32"], optional=False, document="""unit as a string, ex 'm' for meter, 'Pa' for pascal,... Or ansys unit system's ID""")},
                             map_output_pin_spec={
...
class InputsUnitConvert(_Inputs):
    ...
    def unit_name(self):
        ...
        - pindoc: unit as a string, ex 'm' for meter, 'Pa' for pascal,... Or ansys unit system's ID

        Parameters
        ----------
        my_unit_name : str, int, 
