...
class cross_product_fc(Operator):
    """Computes the cross product of two vector fields. Fields could have the same location or Elemental-Nodal and Nodal.
      ...
      >>> op = dpf.operators.math.cross_product_fc(field_or_fields_container_A=my_field_or_fields_container_A,field_or_fields_container_B=my_field_or_fields_container_B)
    ...
    @staticmethod
    def _spec():
        spec = Specification(description="""Computes the cross product of two vector fields. Fields could have the same location or Elemental-Nodal and Nodal.""",
                             map_input_pin_spec={
    ...
    @staticmethod
    def default_config():
        return Operator.default_config(name = "cross_product_fc")
...
class InputsCrossProductFc(_Inputs):
    """Intermediate class used to connect user inputs to cross_product_fc operator
    ...
    def __init__(self, op: Operator):
        ...
        self._field_or_fields_container_A = Input(cross_product_fc._spec().input_pin(0), 0, op, -1) 
        self._inputs.append(self._field_or_fields_container_A)
        self._field_or_fields_container_B = Input(cross_product_fc._spec().input_pin(1), 1, op, -1) 
...
class OutputsCrossProductFc(_Outputs):
    """Intermediate class used to get outputs from cross_product_fc operator
      Examples
      --------
      >>> from ansys.dpf import core as dpf
