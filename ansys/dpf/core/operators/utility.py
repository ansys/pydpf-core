...
"""Operators from /shared/home1/cbellot/ansys_inc/v212/aisol/dll/linx64/libAns.Dpf.FEMutils.so plugin, from "utility" category
"""
    ...
    def _spec():
        spec = Specification(description="""Extract the expected shell layers from the input fields, if the fields contain only one layer then it returns the input fields""",
                             map_input_pin_spec={
                                 ...
                                 1 : PinSpecification(name = "e_shell_layer", type_names=["int32","N14dataProcessing12EShellLayersE"], optional=False, document="""0:Top, 1: Bottom, 2: BottomTop, 3:Mid, 4:BottomTopMid""")},
                             map_output_pin_spec={
...
"""Operators from /shared/home1/cbellot/ansys_inc/v212/aisol/dll/linx64/libAns.Dpf.Native.so plugin, from "utility" category
"""
