...
class von_mises_eqv_fc(Operator):
    """Computes the element-wise Von-Mises criteria on all the tensor fields of a fields container.
      ...
      >>> op = dpf.operators.invariant.von_mises_eqv_fc(fields_container=my_fields_container,poisson_ratio=my_poisson_ratio)

      >>> # Get output data
      >>> result_fields_container = op.outputs.fields_container()"""
    def __init__(self, fields_container=None, poisson_ratio=None, config=None, server=None):
    ...
    def _spec():
        spec = Specification(description="""Computes the element-wise Von-Mises criteria on all the tensor fields of a fields container.""",
                             map_input_pin_spec={
                                 ...
                                 13 : PinSpecification(name = "poisson_ratio", type_names=["double","int32"], optional=False, document="""Poisson ratio to be used in equivalent strain calculation.""")},
                             map_output_pin_spec={
                                 0 : PinSpecification(name = "fields_container", type_names=["fields_container"], optional=False, document="""""")})
        return spec
...
class InputsVonMisesEqvFc(_Inputs):
    ...
    def poisson_ratio(self):
        ...
        - pindoc: Poisson ratio to be used in equivalent strain calculation.

        Parameters
        ----------
        my_poisson_ratio : float, int, 
