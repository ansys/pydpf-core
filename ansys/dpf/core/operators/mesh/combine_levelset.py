...
class combine_levelset(Operator):
    """Takes two levelsets and compute their binary union.
      ...
      >>> op = dpf.operators.mesh.combine_levelset(fieldA=my_fieldA,fieldB=my_fieldB)
    ...
    @staticmethod
    def _spec():
        spec = Specification(description="""Takes two levelsets and compute their binary union.""",
                             map_input_pin_spec={
    ...
    @staticmethod
    def default_config():
        return Operator.default_config(name = "levelset::combine")
...
class InputsCombineLevelset(_Inputs):
    """Intermediate class used to connect user inputs to combine_levelset operator
...
class OutputsCombineLevelset(_Outputs):
    """Intermediate class used to get outputs from combine_levelset operator
      Examples
      --------
      >>> from ansys.dpf import core as dpf
