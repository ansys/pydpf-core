...
class split_fields(Operator):
    """Split the input field or fields container based on the input mesh regions 
      ...
      >>> op = dpf.operators.mesh.split_fields(field_or_fields_container=my_field_or_fields_container,meshes=my_meshes)

      >>> # Get output data
      >>> result_fields_container = op.outputs.fields_container()"""
    def __init__(self, field_or_fields_container=None, meshes=None, config=None, server=None):
    ...
    def _spec():
        spec = Specification(description="""Split the input field or fields container based on the input mesh regions """,
                             map_input_pin_spec={
                                 ...
                                 1 : PinSpecification(name = "meshes", type_names=["meshes_container"], optional=False, document="""body meshes in the mesh controller cannot be mixed shell/solid""")},
                             map_output_pin_spec={
