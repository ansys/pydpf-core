...
class mesh_provider(Operator):
    """Read a mesh from result files
      ...
      >>> op = dpf.operators.mesh.mesh_provider(time_scoping=my_time_scoping,streams_container=my_streams_container,data_sources=my_data_sources)
    ...
    @staticmethod
    def _spec():
        spec = Specification(description="""Read a mesh from result files""",
                             map_input_pin_spec={
                                 0 : PinSpecification(name = "time_scoping", type_names=["int32"], optional=True, document="""optional time/freq set id of the mesh, supported for adaptative meshes"""), 
    ...
    @staticmethod
    def default_config():
        return Operator.default_config(name = "mesh_provider")
...
class InputsMeshProvider(_Inputs):
    ...
    def time_scoping(self):
        ...
        - pindoc: optional time/freq set id of the mesh, supported for adaptative meshes
