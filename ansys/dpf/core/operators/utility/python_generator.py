...
class python_generator(Operator):
    """Generates .py file with specifications for loaded plugin(s).
      ...
      >>> op = dpf.operators.utility.python_generator(dll_source_path=my_dll_source_path,output_path=my_output_path,load_symbol=my_load_symbol,library_key=my_library_key)

      >>> # Get output data"""
    def __init__(self, dll_source_path=None, output_path=None, load_symbol=None, library_key=None, config=None, server=None):
    ...
    def _spec():
        spec = Specification(description="""Generates .py file with specifications for loaded plugin(s).""",
                             map_input_pin_spec={
                                 ...
                                 2 : PinSpecification(name = "load_symbol", type_names=["string"], optional=True, document=""""""), 
                                 3 : PinSpecification(name = "library_key", type_names=["string"], optional=True, document="""""")},
                             map_output_pin_spec={
})
        return spec
