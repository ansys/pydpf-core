    ...
    def _spec():
        spec = Specification(description="""Take a set of fields and assemble them in a unique one""",
                             map_input_pin_spec={
                                 ...
                                 0 : PinSpecification(name = "fields", type_names=["field","fields_container"], optional=False, document="""Either a fields containter, a vector of fields to merge or fields from pin 0 to ..."""), 
                                 1 : PinSpecification(name = "fields", type_names=["field","fields_container"], optional=False, document="""Either a fields containter, a vector of fields to merge or fields from pin 0 to ...""")},
                             map_output_pin_spec={
...
class InputsMergeFields(_Inputs):
    ...
    def fields1(self):
        ...
        - pindoc: Either a fields containter, a vector of fields to merge or fields from pin 0 to ...
