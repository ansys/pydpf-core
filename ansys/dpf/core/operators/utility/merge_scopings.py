...
class merge_scopings(Operator):
    ...
    def _spec():
        spec = Specification(description="""Take a set of scoping and assemble them in a unique one""",
                             map_input_pin_spec={
                                 0 : PinSpecification(name = "scopings", type_names=["scoping"], optional=False, document="""A vector of result info containers to merge or scopings from pin 0 to ...""")},
                             map_output_pin_spec={
...
class InputsMergeScopings(_Inputs):
    ...
    def scopings(self):
        ...
        - pindoc: A vector of result info containers to merge or scopings from pin 0 to ...
