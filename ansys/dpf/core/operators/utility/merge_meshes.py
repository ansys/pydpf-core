...
class merge_meshes(Operator):
    """Take a set of mesh and assemble them in a unique one
      ...
      available inputs:
        - meshes1 (MeshedRegion, MeshesContainer)
        - meshes2 (MeshedRegion, MeshesContainer)
    ...
    def _spec():
        spec = Specification(description="""Take a set of mesh and assemble them in a unique one""",
                             map_input_pin_spec={
                                 0 : PinSpecification(name = "meshes", type_names=["abstract_meshed_region","meshes_container"], optional=False, document="""Either a meshes container, a vector of meshed region to merge or meshed region from pin 0 to ..."""), 
                                 1 : PinSpecification(name = "meshes", type_names=["abstract_meshed_region","meshes_container"], optional=False, document="""Either a meshes container, a vector of meshed region to merge or meshed region from pin 0 to ...""")},
                             map_output_pin_spec={
...
class InputsMergeMeshes(_Inputs):
    ...
    def meshes1(self):
        ...
        - pindoc: Either a meshes container, a vector of meshed region to merge or meshed region from pin 0 to ...

        Parameters
        ----------
        my_meshes1 : MeshedRegion, MeshesContainer, 
    ...
    def meshes2(self):
        ...
        Parameters
        ----------
        my_meshes2 : MeshedRegion, MeshesContainer, 
