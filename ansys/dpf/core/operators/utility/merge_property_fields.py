...
class merge_property_fields(Operator):
    ...
    def _spec():
        spec = Specification(description="""Take a set of property fields and assemble them in a unique one""",
                             map_input_pin_spec={
                                 0 : PinSpecification(name = "vector_shared_ptr_property_field__", type_names=["property_field"], optional=False, document="""A vector of property fields to merge or property fields from pin 0 to ..."""), 
                                 1 : PinSpecification(name = "vector_shared_ptr_property_field__", type_names=["property_field"], optional=False, document="""A vector of property fields to merge or property fields from pin 0 to ...""")},
                             map_output_pin_spec={
...
class InputsMergePropertyFields(_Inputs):
    ...
    def vector_shared_ptr_property_field__1(self):
        ...
        - pindoc: A vector of property fields to merge or property fields from pin 0 to ...
