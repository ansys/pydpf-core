...
class split_on_property_type(Operator):
    """Splits a given scoping or the mesh scoping (nodal or elemental) on given properties (elshape and/or material) and returns a scopings container with those split scopings.
      ...
      >>> op = dpf.operators.scoping.split_on_property_type(mesh_scoping=my_mesh_scoping,mesh=my_mesh,requested_location=my_requested_location,skin_case=my_skin_case,label1=my_label1,label2=my_label2)

      >>> # Get output data
      >>> result_mesh_scoping = op.outputs.mesh_scoping()"""
    def __init__(self, mesh_scoping=None, mesh=None, requested_location=None, skin_case=None, label1=None, label2=None, config=None, server=None):
    ...
    def _spec():
        spec = Specification(description="""Splits a given scoping or the mesh scoping (nodal or elemental) on given properties (elshape and/or material) and returns a scopings container with those split scopings.""",
                             map_input_pin_spec={
                                 ...
                                 12 : PinSpecification(name = "skin_case", type_names=["int32"], optional=True, document="""set to 0: to have skin elements in their own group, 1: merge skin and solid elements, 2: merge skin and shell elements (default)"""), 
...
class InputsSplitOnPropertyType(_Inputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._skin_case = Input(split_on_property_type._spec().input_pin(12), 12, op, -1) 
    ...
    def skin_case(self):
        ...
        - pindoc: set to 0: to have skin elements in their own group, 1: merge skin and solid elements, 2: merge skin and shell elements (default)
