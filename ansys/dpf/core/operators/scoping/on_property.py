    ...
    def _spec():
        spec = Specification(description="""Provides a scoping at a given location based on a given property name and a property number.""",
                             map_input_pin_spec={
                                 ...
                                 1 : PinSpecification(name = "property_name", type_names=["string"], optional=False, document="""ex "mapdl_element_type", "mapdl_element_type_id", "apdl_type_index", "mapdl_type_id", "material", "apdl_section_id", "apdl_real_id", "shell_axi", "volume_axi"..."""), 
...
class InputsOnProperty(_Inputs):
    ...
    def property_name(self):
        ...
        - pindoc: ex "mapdl_element_type", "mapdl_element_type_id", "apdl_type_index", "mapdl_type_id", "material", "apdl_section_id", "apdl_real_id", "shell_axi", "volume_axi"...
