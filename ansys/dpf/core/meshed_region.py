...
class MeshedRegion:
    ...
    def plot(
        ...
        **kwargs : optional
        ...
        pl.add_mesh(self, scaling_result=scaling_result, scaling_factor=scaling_factor,
