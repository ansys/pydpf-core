...
from ansys.dpf import scoping, field
from ansys.dpf.common import locations
...
class MeshedRegion:
    ...
    def __init__(self, mesh, channel=None):
        ...
        Attributes
        ----------
        nodes : ansys.dpf.meshed_region.Nodes
            Entity containing all the nodal properties
        
        elements : ansys.dpf.meshed_region.Elements
    ...
    def _get_scoping(self, loc=locations.nodal):
        ...
        Parameters
        ----------
        loc : str or ansys.dpf.common.locations, optional
    ...
    def _as_vtk(self, as_linear=True):
        ...
        from ansys.dpf.vtk_helper import dpf_mesh_to_vtk
...
class Nodes():
    ...
    def __get_node(self, nodeindex=None, nodeid=None):
        ...
        Returns
        -------
        node : ansys.dpf.meshed_region.Node
            Requested node
        """
        request = meshed_region_pb2.GetRequest()
        request.mesh.CopyFrom(self._mesh._message)
        request.loc.location = dpf.locations.nodal
    ...
    @property
    def scoping(self):
        return self._mesh._get_scoping(loc=dpf.locations.nodal)
...
class Elements():
    ...
    def __get_element(self, elementindex=None, elementid=None):
        ...
        request = meshed_region_pb2.GetRequest()
        request.mesh.CopyFrom(self._mesh._message)
        request.loc.location = dpf.locations.elemental
