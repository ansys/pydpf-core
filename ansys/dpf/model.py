...
class Model():
    ...
    Parameters
    ----------
    data_sources : str, dpf.DataSources
        Accepts either a dpf.DataSources instance or a filename of the
        result file to open.
...
class Metadata :
    ...
    def data_sources(self):
        ...
        Returns
        -------
        ds : ansys.dpf.DataSources
        """
        return self._data_sources
    
    def _set_data_sources(self, var_inp):
        if isinstance(var_inp, dpf.DataSources):
    ...
    def __mesh_provider(self):
        ...
        Returns
        -------
        mesh_provider : ansys.dpf.Operator
            Mesh provider operator.
