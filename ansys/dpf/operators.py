...
from ansys.dpf.common import types as dpf_types
...
def sum(var_inp):
    ...
    Parameters
    ----------
    var_inp : ansys.dpf.FieldsContainer, ansys.dpf.Field, or ansys.dpf.Operator
    ...
    Sum element volume using dpf.sum
    ...
    sum_op = dpf.Operator('accumulate')

    if isinstance(var_inp, dpf.Field):
        sum_op.connect(var_inp)
    elif isinstance(var_inp, dpf.FieldsContainer):
        if len(var_inp) > 1:
            raise typ_err
        sum_op.connect(var_inp)
    elif isinstance(var_inp, dpf.Operator):
...
def to_nodal(var_inp):
    ...
    _check_type(var_inp, dpf.Field)
    if isinstance(var_inp, dpf.Field):
        oper = dpf.Operator('to_nodal')
        return oper.get_output(0, dpf_types.field)
    elif isinstance(var_inp, dpf.FieldsContainer):
        oper = dpf.Operator('to_nodal_fc')
...
def norm(var_inp):
    ...
    Returns
    -------
    field : ansys.dpf.Field, ansys.dpf.FieldContainer, or ansys.dpf.Operator
...
def _norm_fc(fields):
    ...
    Returns
    -------
    fields : ansys.dpf.FieldsContainer
        Euclidian norm of the fields.
    """
    _check_type(fields, dpf.FieldsContainer)
...
def _norm_op(oper):
    ...
    Returns
    -------
    oper : ansys.dpf.Operator
        Chained euclidean norm operator.
    """
    _check_type(oper, dpf.Operator)
...
def eqv(var_inp):
    ...
    Returns
    -------
    field : ansys.dpf.Field, ansys.dpf.FieldContainer
...
def _min_max_oper(oper):
    ...
    min_max_oper = dpf.Operator('min_max_fc')
...
def add(a, b):
    ...
    Parameters
    ----------
    a : ansys.dpf.Field or ansys.dpf.FieldContainer
        Field/or fields container containing only one field.

    b : ansys.dpf.Field or ansys.dpf.FieldContainer
        Field/or fields container containing only one field.

    Returns
    -------
    field_sum : ansys.dpf.Field
        Sum of the two fields.
    """
    _check_type(a, (dpf.Field, dpf.FieldsContainer))
    _check_type(b, (dpf.Field, dpf.FieldsContainer))

    sum_oper = dpf.Operator('add')
    sum_oper.connect(0, a)
    sum_oper.connect(1, a)
    return sum_oper.get_output(0, dpf.types.field)
...
def element_dot(a, b):
    ...
    op.connect(0, a)
    op.connect(1, b)
    return op.get_output(0, dpf.types.field)
...
def sqr(field):
    ...
    Parameters
    ----------
    field : ansys.dpf.Field or ansys.dpf.FieldContainer
        Field/or fields container containing only one field.

    Returns
    -------
    field_sqr : ansys.dpf.Field
    ...
    _check_type(field, (dpf.Field, dpf.FieldsContainer))
    op = dpf.Operator('sqr')
    op.connect(0, field)
    return op.get_output(0, dpf.types.field)
...
def dot_tensor(a, b):
    ...
    >>> field_out = dpf.operators.dot_tensor(field_a, field_b)
...
def component_selector(var_inp, index):
    ...
    Parameters
    ----------
    var_inp : ansys.dpf.Field, ansys.dpf.FieldsContainer
    ...
    Returns
    -------
    fields : ansys.dpf.Field, ansys.dpf.FieldsContainer
