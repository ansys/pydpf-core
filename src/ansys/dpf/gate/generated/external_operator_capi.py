...
class ExternalOperatorCAPI(external_operator_abstract_api.ExternalOperatorAbstractAPI):
	...
	def external_operator_get_in_property_fields_container(operator_data, pin_index):
		errorSize = ctypes.c_int(0)
		sError = ctypes.c_wchar_p()
		res = capi.dll.ExternalOperator_getInPropertyFieldsContainer(operator_data, utils.to_int32(pin_index), ctypes.byref(utils.to_int32(errorSize)), ctypes.byref(sError))
		if errorSize.value != 0:
			raise errors.DPFServerException(sError.value)
		return res
