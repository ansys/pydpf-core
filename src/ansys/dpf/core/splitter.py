...
class Splitter:
    def __init__(self, start_op: core.Operator, end_op: core.Operator, scoping: core.Scoping, scoping_pin: int = None):
        """"""
...
#                                                                    +----------+
#
    def split(self, chunk_size: int, end_input_pin: int = 0, rescope: bool = False) -> Tuple[core.Operator,core.Operator]:
...
def split_workflow_in_chunks(start_op: core.Operator, end_op: core.Operator, scoping: core.Scoping, rescope: bool = False, max_bytes: int = 1024**3, dict_inputs: Dict[int, Any] = {}, chunk_size: int = None, scoping_pin: int = None, end_input_pin: int = 0):
