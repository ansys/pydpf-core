...
3. For a face finite volume mesh inverse distance weighted average is used.
      ...
      >>> op = dpf.operators.averaging.elemental_to_nodal_fc(fields_container=my_fields_container,mesh=my_mesh,force_averaging=my_force_averaging,mesh_scoping=my_mesh_scoping,algorithm=my_algorithm)

      >>> # Get output data
      >>> result_fields_container = op.outputs.fields_container()"""
    def __init__(self, fields_container=None, mesh=None, force_averaging=None, mesh_scoping=None, algorithm=None, config=None, server=None):
    ...
    @staticmethod
    def _spec():
        spec = Specification(description="""Transforms Elemental Nodal fields to Nodal fields. The result is computed on a given node's scoping.1. For a finite element mesh, the value on a node is the average of the values of the neighbour elements.
...
3. For a face finite volume mesh inverse distance weighted average is used.""",
                             map_input_pin_spec={
                                 ...
                                 200 : PinSpecification(name = "algorithm", type_names=["int32"], optional=True, document="""Forces the usage of algorithm 1, 2 or 3 (default is chosen based on the type of mesh).""")},
                             map_output_pin_spec={
                                 0 : PinSpecification(name = "fields_container", type_names=["fields_container"], optional=False, document="""""")})
        return spec
...
class InputsElementalToNodalFc(_Inputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._algorithm = Input(elemental_to_nodal_fc._spec().input_pin(200), 200, op, -1) 
    ...
    def algorithm(self):
        ...
        - pindoc: Forces the usage of algorithm 1, 2 or 3 (default is chosen based on the type of mesh).
