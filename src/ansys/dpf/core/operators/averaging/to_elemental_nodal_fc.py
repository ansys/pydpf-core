...
class to_elemental_nodal_fc(Operator):
    ...
    @staticmethod
    def _spec():
        spec = Specification(description="""Transforms fields into Elemental Nodal fields using an averaging process. The result is computed on a given element's scoping.""",
                             map_input_pin_spec={
