...
class on_mesh_property(Operator):
    ...
    @staticmethod
    def _spec():
        description = """Provides a scoping on a given property name and a property number."""
        spec = Specification(
    ...
    def default_config(server=None):
        ...
        """
        return Operator.default_config(name="meshscoping_provider_by_prop", server=server)
