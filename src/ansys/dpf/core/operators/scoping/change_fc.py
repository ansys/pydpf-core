...
class change_fc(Operator):
    """Rescopes/splits a fields container to correspond to a scopings container.
      ...
      >>> op = dpf.operators.scoping.change_fc(field_or_fields_container=my_field_or_fields_container,scopings_container=my_scopings_container)

      >>> # Get output data
      >>> result_fields_container = op.outputs.fields_container()"""
    def __init__(self, field_or_fields_container=None, scopings_container=None, config=None, server=None):
    ...
    @staticmethod
    def _spec():
        spec = Specification(description="""Rescopes/splits a fields container to correspond to a scopings container.""",
                             map_input_pin_spec={
                                 0 : PinSpecification(name = "field_or_fields_container", type_names=["fields_container","field"], optional=False, document=""""""), 
...
class InputsChangeFc(_Inputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._field_or_fields_container = Input(change_fc._spec().input_pin(0), 0, op, -1) 
