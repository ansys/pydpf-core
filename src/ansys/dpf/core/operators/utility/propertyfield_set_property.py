...
class propertyfield_set_property(Operator):
    ...
    Returns
    -------
    field: PropertyField or PropertyFieldsContainer
...
class OutputsPropertyfieldSetProperty(_Outputs):
    ...
    def __init__(self, op: Operator):
        ...
        self.field_as_property_fields_container = Output(
            _modify_output_spec_with_one_type(
        ...
        self._outputs.append(self.field_as_property_fields_container)
