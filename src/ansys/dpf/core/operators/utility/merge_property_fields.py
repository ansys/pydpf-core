...
class merge_property_fields(Operator):
    ...
    >>> op.inputs.vector_shared_ptr_property_field__1.connect(
    ...     my_vector_shared_ptr_property_field__1
    ... )
    >>> my_vector_shared_ptr_property_field__2 = dpf.PropertyField()
    >>> op.inputs.vector_shared_ptr_property_field__2.connect(
    ...     my_vector_shared_ptr_property_field__2
    ... )
    ...
    @staticmethod
    def _spec():
        description = """Take a set of property fields and assemble them in a unique one"""
        spec = Specification(
...
class InputsMergePropertyFields(_Inputs):
    ...
    def vector_shared_ptr_property_field__1(self):
        ...
        ... )
        >>> # or
        >>> op.inputs.vector_shared_ptr_property_field__1(
        ...     my_vector_shared_ptr_property_field__1
        ... )
        """
    ...
    def vector_shared_ptr_property_field__2(self):
        ...
        ... )
        >>> # or
        >>> op.inputs.vector_shared_ptr_property_field__2(
        ...     my_vector_shared_ptr_property_field__2
        ... )
        """
