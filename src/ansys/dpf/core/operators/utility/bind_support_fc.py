...
class bind_support_fc(Operator):
    """Ties a support to a fields container.
      ...
      available inputs:
        ...
        - support (MeshedRegion, AbstractFieldSupport, TimeFreqSupport)
    ...
    @staticmethod
    def _spec():
        spec = Specification(description="""Ties a support to a fields container.""",
                             map_input_pin_spec={
                                 0 : PinSpecification(name = "fields_container", type_names=["fields_container"], optional=False, document=""""""), 
                                 1 : PinSpecification(name = "support", type_names=["abstract_meshed_region","abstract_field_support","time_freq_support"], optional=False, document="""Meshed region or a support of the field.""")},
                             map_output_pin_spec={
                                 0 : PinSpecification(name = "fields_container", type_names=["fields_container"], optional=False, document="""""")})
        return spec
...
class InputsBindSupportFc(_Inputs):
    ...
    def support(self):
        ...
        Parameters
        ----------
        my_support : MeshedRegion, AbstractFieldSupport, TimeFreqSupport, 
