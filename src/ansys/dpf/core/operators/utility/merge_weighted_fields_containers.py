...
class merge_weighted_fields_containers(Operator):
    ...
    fields_containers2: FieldsContainer
        A vector of fields containers to merge or fields containers from pin 0 to ...
    weights1: PropertyFieldsCollection
        Weights to apply to each field from pin 1000 to ...
    weights2: PropertyFieldsCollection
        Weights to apply to each field from pin 1000 to ...
    ...
    >>> my_weights1 = dpf.PropertyFieldsCollection()
    >>> op.inputs.weights1.connect(my_weights1)
    >>> my_weights2 = dpf.PropertyFieldsCollection()
...
class InputsMergeWeightedFieldsContainers(_Inputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._weights1: Input[PropertyFieldsCollection] = Input(
            merge_weighted_fields_containers._spec().input_pin(1000), 1000, op, 0
        )
        self._inputs.append(self._weights1)
        self._weights2: Input[PropertyFieldsCollection] = Input(
    ...
    @property
    def weights1(self) -> Input[PropertyFieldsCollection]:
    ...
    @property
    def weights2(self) -> Input[PropertyFieldsCollection]:
