...
class OutputsCustomtypefieldGetAttribute(_Outputs):
    ...
    def __init__(self, op: Operator):
        ...
        self.property_as_int32 = Output(
            _modify_output_spec_with_one_type(
                customtypefield_get_attribute._spec().output_pin(0), "int32"
            ),
            0,
            op,
        )
        ...
        self.property_as_vector_double_ = Output(
            _modify_output_spec_with_one_type(
                customtypefield_get_attribute._spec().output_pin(0), "vector_double_"
            ),
            0,
            op,
        )
        ...
        self.property_as_vector_int32_ = Output(
            _modify_output_spec_with_one_type(
                customtypefield_get_attribute._spec().output_pin(0), "vector_int32_"
            ),
            0,
            op,
        )
        ...
        self.property_as_vector_string_ = Output(
            _modify_output_spec_with_one_type(
                customtypefield_get_attribute._spec().output_pin(0), "vector_string_"
            ),
            0,
            op,
        )
        ...
        self.property_as_vector_char_ = Output(
            _modify_output_spec_with_one_type(
                customtypefield_get_attribute._spec().output_pin(0), "vector_char_"
            ),
            0,
            op,
        )
