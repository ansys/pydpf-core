...
class reaction_moments_X(Operator):
    r"""Read/compute nodal reaction moments X component of the vector (1st
    ...
    >>> op = dpf.operators.result.reaction_moments_X()
    ...
    def __init__(
        ...
        super().__init__(
            ...
            config=config,
            server=server,
            inputs_type=InputsReactionMomentsX,
            outputs_type=OutputsReactionMomentsX,
        )
    ...
    def _spec() -> Specification:
        description = r"""Read/compute nodal reaction moments X component of the vector (1st
component) by calling the readers defined by the datasources.
"""
        spec = Specification(
    ...
    def default_config(server: AnyServerType = None) -> Config:
        ...
        """
        return Operator.default_config(name="RF_MomentX", server=server)

    @property
    def inputs(self) -> InputsReactionMomentsX:
        """Enables to connect inputs to the operator

        Returns
        --------
        inputs:
            An instance of InputsReactionMomentsX.
        """
        return self._inputs

    @property
    def outputs(self) -> OutputsReactionMomentsX:
        """Enables to get outputs of the operator by evaluating it

        Returns
        --------
        outputs:
            An instance of OutputsReactionMomentsX.
        """
        return self._outputs


class InputsReactionMomentsX(_Inputs):
    """Intermediate class used to connect user inputs to
    reaction_moments_X operator.
...
class OutputsReactionMomentsX(_Outputs):
    ...
    def __init__(self, op: Operator):
        super().__init__(reaction_moments_X._spec().outputs, op)
        self._fields_container: Output[FieldsContainer] = Output(
            reaction_moments_X._spec().output_pin(0), 0, op
        )
