...
class reaction_moments_Z(Operator):
    r"""Read/compute nodal reaction moments Z component of the vector (3rd
    ...
    >>> op = dpf.operators.result.reaction_moments_Z()
    ...
    def __init__(
        ...
        super().__init__(
            ...
            config=config,
            server=server,
            inputs_type=InputsReactionMomentsZ,
            outputs_type=OutputsReactionMomentsZ,
        )
    ...
    def _spec() -> Specification:
        description = r"""Read/compute nodal reaction moments Z component of the vector (3rd
component) by calling the readers defined by the datasources.
"""
        spec = Specification(
    ...
    def default_config(server: AnyServerType = None) -> Config:
        ...
        """
        return Operator.default_config(name="RF_MomentZ", server=server)

    @property
    def inputs(self) -> InputsReactionMomentsZ:
        """Enables to connect inputs to the operator

        Returns
        --------
        inputs:
            An instance of InputsReactionMomentsZ.
        """
        return self._inputs

    @property
    def outputs(self) -> OutputsReactionMomentsZ:
        """Enables to get outputs of the operator by evaluating it

        Returns
        --------
        outputs:
            An instance of OutputsReactionMomentsZ.
        """
        return self._outputs


class InputsReactionMomentsZ(_Inputs):
    """Intermediate class used to connect user inputs to
    reaction_moments_Z operator.
...
class OutputsReactionMomentsZ(_Outputs):
    ...
    def __init__(self, op: Operator):
        super().__init__(reaction_moments_Z._spec().outputs, op)
        self._fields_container: Output[FieldsContainer] = Output(
            reaction_moments_Z._spec().output_pin(0), 0, op
        )
