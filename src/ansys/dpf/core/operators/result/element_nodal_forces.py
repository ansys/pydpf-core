...
class element_nodal_forces(Operator):
    ...
    processed to infer if scoping transposition or result averaging is
    needed, with the resulting output fields having ‘Nodal’,
    ‘ElementalNodal’ or ‘Elemental’ location. - Once the need for averaging
    has been detected, the behavior of the combined connection of the
    ‘split_shells’ and ‘shell_layer’ pins is:
