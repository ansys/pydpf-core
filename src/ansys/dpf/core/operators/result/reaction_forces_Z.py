...
class reaction_forces_Z(Operator):
    ...
    >>> op = dpf.operators.result.reaction_forces_Z()
    ...
    def __init__(
        ...
        super().__init__(
            ...
            config=config,
            server=server,
            inputs_type=InputsReactionForcesZ,
            outputs_type=OutputsReactionForcesZ,
        )
...
"""
    ...
    @property
    def inputs(self) -> InputsReactionForcesZ:
        """Enables to connect inputs to the operator

        Returns
        --------
        inputs:
            An instance of InputsReactionForcesZ.
        """
        return self._inputs

    @property
    def outputs(self) -> OutputsReactionForcesZ:
        """Enables to get outputs of the operator by evaluating it

        Returns
        --------
        outputs:
            An instance of OutputsReactionForcesZ.
        """
        return self._outputs


class InputsReactionForcesZ(_Inputs):
    """Intermediate class used to connect user inputs to
    reaction_forces_Z operator.
...
class OutputsReactionForcesZ(_Outputs):
    ...
    def __init__(self, op: Operator):
        super().__init__(reaction_forces_Z._spec().outputs, op)
        self._fields_container: Output[FieldsContainer] = Output(
            reaction_forces_Z._spec().output_pin(0), 0, op
        )
