...
class reaction_moment_X(Operator):
    ...
    >>> op = dpf.operators.result.reaction_moment_X()
    ...
    def __init__(
        ...
        super().__init__(
            ...
            config=config,
            server=server,
            inputs_type=InputsReactionMomentX,
            outputs_type=OutputsReactionMomentX,
        )
...
"""
    ...
    @property
    def inputs(self) -> InputsReactionMomentX:
        """Enables to connect inputs to the operator

        Returns
        --------
        inputs:
            An instance of InputsReactionMomentX.
        """
        return self._inputs

    @property
    def outputs(self) -> OutputsReactionMomentX:
        """Enables to get outputs of the operator by evaluating it

        Returns
        --------
        outputs:
            An instance of OutputsReactionMomentX.
        """
        return self._outputs


class InputsReactionMomentX(_Inputs):
    """Intermediate class used to connect user inputs to
    reaction_moment_X operator.
...
class OutputsReactionMomentX(_Outputs):
    ...
    def __init__(self, op: Operator):
        super().__init__(reaction_moment_X._spec().outputs, op)
        self._fields_container: Output[FieldsContainer] = Output(
            reaction_moment_X._spec().output_pin(0), 0, op
        )
