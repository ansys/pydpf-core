...
class InputsComputeElasticStrainXy(_Inputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._time_scoping = Input(compute_elastic_strain_XY._spec().input_pin(0), 0, op, -1)
        self._inputs.append(self._time_scoping)
        self._scoping = Input(compute_elastic_strain_XY._spec().input_pin(1), 1, op, -1)
        self._inputs.append(self._scoping)
        self._streams_container = Input(compute_elastic_strain_XY._spec().input_pin(3), 3, op, -1)
        self._inputs.append(self._streams_container)
        self._data_sources = Input(compute_elastic_strain_XY._spec().input_pin(4), 4, op, -1)
        self._inputs.append(self._data_sources)
        self._extrapolate = Input(compute_elastic_strain_XY._spec().input_pin(5), 5, op, -1)
        self._inputs.append(self._extrapolate)
        self._nonlinear = Input(compute_elastic_strain_XY._spec().input_pin(6), 6, op, -1)
        ...
        self._requested_location = Input(compute_elastic_strain_XY._spec().input_pin(9), 9, op, -1)
        self._inputs.append(self._requested_location)
        self._displacement = Input(compute_elastic_strain_XY._spec().input_pin(10), 10, op, -1)
