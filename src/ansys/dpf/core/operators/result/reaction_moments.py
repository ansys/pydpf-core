...
class reaction_moments(Operator):
    r"""Read/compute nodal reaction moments by calling the readers defined by
    the datasources.
    ...
    >>> op = dpf.operators.result.reaction_moments()
    ...
    def __init__(
        ...
        super().__init__(
            ...
            config=config,
            server=server,
            inputs_type=InputsReactionMoments,
            outputs_type=OutputsReactionMoments,
        )
    ...
    def _spec() -> Specification:
        description = r"""Read/compute nodal reaction moments by calling the readers defined by
the datasources.
"""
        spec = Specification(
    ...
    def default_config(server: AnyServerType = None) -> Config:
        ...
        """
        return Operator.default_config(name="RF_Moment", server=server)

    @property
    def inputs(self) -> InputsReactionMoments:
        """Enables to connect inputs to the operator

        Returns
        --------
        inputs:
            An instance of InputsReactionMoments.
        """
        return self._inputs

    @property
    def outputs(self) -> OutputsReactionMoments:
        """Enables to get outputs of the operator by evaluating it

        Returns
        --------
        outputs:
            An instance of OutputsReactionMoments.
        """
        return self._outputs


class InputsReactionMoments(_Inputs):
    """Intermediate class used to connect user inputs to
    reaction_moments operator.
...
class OutputsReactionMoments(_Outputs):
    ...
    def __init__(self, op: Operator):
        super().__init__(reaction_moments._spec().outputs, op)
        self._fields_container: Output[FieldsContainer] = Output(
            reaction_moments._spec().output_pin(0), 0, op
        )
