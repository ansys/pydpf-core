...
class reaction_forces_Y(Operator):
    ...
    >>> op = dpf.operators.result.reaction_forces_Y()
    ...
    def __init__(
        ...
        super().__init__(
            ...
            config=config,
            server=server,
            inputs_type=InputsReactionForcesY,
            outputs_type=OutputsReactionForcesY,
        )
...
"""
    ...
    @property
    def inputs(self) -> InputsReactionForcesY:
        """Enables to connect inputs to the operator

        Returns
        --------
        inputs:
            An instance of InputsReactionForcesY.
        """
        return self._inputs

    @property
    def outputs(self) -> OutputsReactionForcesY:
        """Enables to get outputs of the operator by evaluating it

        Returns
        --------
        outputs:
            An instance of OutputsReactionForcesY.
        """
        return self._outputs


class InputsReactionForcesY(_Inputs):
    """Intermediate class used to connect user inputs to
    reaction_forces_Y operator.
...
class OutputsReactionForcesY(_Outputs):
    ...
    def __init__(self, op: Operator):
        super().__init__(reaction_forces_Y._spec().outputs, op)
        self._fields_container: Output[FieldsContainer] = Output(
            reaction_forces_Y._spec().output_pin(0), 0, op
        )
