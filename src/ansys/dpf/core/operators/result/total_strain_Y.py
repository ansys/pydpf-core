...
class total_strain_Y(Operator):
    r"""Read/compute element nodal component total strains YY normal component
    ...
    >>> op = dpf.operators.result.total_strain_Y()
    ...
    def __init__(
        ...
        super().__init__(
            ...
            config=config,
            server=server,
            inputs_type=InputsTotalStrainY,
            outputs_type=OutputsTotalStrainY,
        )
    ...
    def _spec() -> Specification:
        description = r"""Read/compute element nodal component total strains YY normal component
(11 component) by calling the readers defined by the datasources.
Regarding the requested location and the input mesh scoping, the result
location can be Nodal/ElementalNodal/Elemental.
"""
    ...
    def default_config(server: AnyServerType = None) -> Config:
        ...
        """
        return Operator.default_config(name="ELY", server=server)

    @property
    def inputs(self) -> InputsTotalStrainY:
        """Enables to connect inputs to the operator

        Returns
        --------
        inputs:
            An instance of InputsTotalStrainY.
        """
        return self._inputs

    @property
    def outputs(self) -> OutputsTotalStrainY:
        """Enables to get outputs of the operator by evaluating it

        Returns
        --------
        outputs:
            An instance of OutputsTotalStrainY.
        """
        return self._outputs


class InputsTotalStrainY(_Inputs):
    """Intermediate class used to connect user inputs to
    total_strain_Y operator.
...
class OutputsTotalStrainY(_Outputs):
    ...
    def __init__(self, op: Operator):
        super().__init__(total_strain_Y._spec().outputs, op)
        self._fields_container: Output[FieldsContainer] = Output(
            total_strain_Y._spec().output_pin(0), 0, op
        )
