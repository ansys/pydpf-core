...
class total_strain_X(Operator):
    r"""Read/compute element nodal component total strains XX normal component
    ...
    >>> op = dpf.operators.result.total_strain_X()
    ...
    def __init__(
        ...
        super().__init__(
            ...
            config=config,
            server=server,
            inputs_type=InputsTotalStrainX,
            outputs_type=OutputsTotalStrainX,
        )
    ...
    def _spec() -> Specification:
        description = r"""Read/compute element nodal component total strains XX normal component
(00 component) by calling the readers defined by the datasources.
Regarding the requested location and the input mesh scoping, the result
location can be Nodal/ElementalNodal/Elemental.
"""
    ...
    def default_config(server: AnyServerType = None) -> Config:
        ...
        """
        return Operator.default_config(name="ELX", server=server)

    @property
    def inputs(self) -> InputsTotalStrainX:
        """Enables to connect inputs to the operator

        Returns
        --------
        inputs:
            An instance of InputsTotalStrainX.
        """
        return self._inputs

    @property
    def outputs(self) -> OutputsTotalStrainX:
        """Enables to get outputs of the operator by evaluating it

        Returns
        --------
        outputs:
            An instance of OutputsTotalStrainX.
        """
        return self._outputs


class InputsTotalStrainX(_Inputs):
    """Intermediate class used to connect user inputs to
    total_strain_X operator.
...
class OutputsTotalStrainX(_Outputs):
    ...
    def __init__(self, op: Operator):
        super().__init__(total_strain_X._spec().outputs, op)
        self._fields_container: Output[FieldsContainer] = Output(
            total_strain_X._spec().output_pin(0), 0, op
        )
