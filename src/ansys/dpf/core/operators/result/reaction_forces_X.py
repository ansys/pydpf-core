...
class reaction_forces_X(Operator):
    ...
    >>> op = dpf.operators.result.reaction_forces_X()
    ...
    def __init__(
        ...
        super().__init__(
            ...
            config=config,
            server=server,
            inputs_type=InputsReactionForcesX,
            outputs_type=OutputsReactionForcesX,
        )
...
"""
    ...
    @property
    def inputs(self) -> InputsReactionForcesX:
        """Enables to connect inputs to the operator

        Returns
        --------
        inputs:
            An instance of InputsReactionForcesX.
        """
        return self._inputs

    @property
    def outputs(self) -> OutputsReactionForcesX:
        """Enables to get outputs of the operator by evaluating it

        Returns
        --------
        outputs:
            An instance of OutputsReactionForcesX.
        """
        return self._outputs


class InputsReactionForcesX(_Inputs):
    """Intermediate class used to connect user inputs to
    reaction_forces_X operator.
...
class OutputsReactionForcesX(_Outputs):
    ...
    def __init__(self, op: Operator):
        super().__init__(reaction_forces_X._spec().outputs, op)
        self._fields_container: Output[FieldsContainer] = Output(
            reaction_forces_X._spec().output_pin(0), 0, op
        )
