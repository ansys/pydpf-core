...
class total_strain_YZ(Operator):
    r"""Read/compute element nodal component total strains YZ shear component
    ...
    >>> op = dpf.operators.result.total_strain_YZ()
    ...
    def __init__(
        ...
        super().__init__(
            ...
            config=config,
            server=server,
            inputs_type=InputsTotalStrainYz,
            outputs_type=OutputsTotalStrainYz,
        )
    ...
    def _spec() -> Specification:
        description = r"""Read/compute element nodal component total strains YZ shear component
(12 component) by calling the readers defined by the datasources.
Regarding the requested location and the input mesh scoping, the result
location can be Nodal/ElementalNodal/Elemental.
"""
    ...
    def default_config(server: AnyServerType = None) -> Config:
        ...
        """
        return Operator.default_config(name="ELYZ", server=server)

    @property
    def inputs(self) -> InputsTotalStrainYz:
        """Enables to connect inputs to the operator

        Returns
        --------
        inputs:
            An instance of InputsTotalStrainYz.
        """
        return self._inputs

    @property
    def outputs(self) -> OutputsTotalStrainYz:
        """Enables to get outputs of the operator by evaluating it

        Returns
        --------
        outputs:
            An instance of OutputsTotalStrainYz.
        """
        return self._outputs


class InputsTotalStrainYz(_Inputs):
    """Intermediate class used to connect user inputs to
    total_strain_YZ operator.
...
class OutputsTotalStrainYz(_Outputs):
    ...
    def __init__(self, op: Operator):
        super().__init__(total_strain_YZ._spec().outputs, op)
        self._fields_container: Output[FieldsContainer] = Output(
            total_strain_YZ._spec().output_pin(0), 0, op
        )
