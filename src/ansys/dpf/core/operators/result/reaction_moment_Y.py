...
class reaction_moment_Y(Operator):
    ...
    >>> op = dpf.operators.result.reaction_moment_Y()
    ...
    def __init__(
        ...
        super().__init__(
            ...
            config=config,
            server=server,
            inputs_type=InputsReactionMomentY,
            outputs_type=OutputsReactionMomentY,
        )
...
"""
    ...
    @property
    def inputs(self) -> InputsReactionMomentY:
        """Enables to connect inputs to the operator

        Returns
        --------
        inputs:
            An instance of InputsReactionMomentY.
        """
        return self._inputs

    @property
    def outputs(self) -> OutputsReactionMomentY:
        """Enables to get outputs of the operator by evaluating it

        Returns
        --------
        outputs:
            An instance of OutputsReactionMomentY.
        """
        return self._outputs


class InputsReactionMomentY(_Inputs):
    """Intermediate class used to connect user inputs to
    reaction_moment_Y operator.
...
class OutputsReactionMomentY(_Outputs):
    ...
    def __init__(self, op: Operator):
        super().__init__(reaction_moment_Y._spec().outputs, op)
        self._fields_container: Output[FieldsContainer] = Output(
            reaction_moment_Y._spec().output_pin(0), 0, op
        )
