...
class nmisc(Operator):
    ...
    Expansion) and Cyclic Expansion procedures are not supported since
    ...
    def _spec():
        description = """Read/compute elemental non summable miscellaneous data by calling the
            ...
            Demand Expansion) and Cyclic Expansion procedures are not
            supported since results cannot be summed."""
        spec = Specification(
