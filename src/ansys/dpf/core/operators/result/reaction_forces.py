...
class reaction_forces(Operator):
    ...
    >>> op = dpf.operators.result.reaction_forces()
    ...
    def __init__(
        ...
        super().__init__(
            ...
            config=config,
            server=server,
            inputs_type=InputsReactionForces,
            outputs_type=OutputsReactionForces,
        )
...
"""
    ...
    @property
    def inputs(self) -> InputsReactionForces:
        """Enables to connect inputs to the operator

        Returns
        --------
        inputs:
            An instance of InputsReactionForces.
        """
        return self._inputs

    @property
    def outputs(self) -> OutputsReactionForces:
        """Enables to get outputs of the operator by evaluating it

        Returns
        --------
        outputs:
            An instance of OutputsReactionForces.
        """
        return self._outputs


class InputsReactionForces(_Inputs):
    """Intermediate class used to connect user inputs to
    reaction_forces operator.
...
class OutputsReactionForces(_Outputs):
    ...
    def __init__(self, op: Operator):
        super().__init__(reaction_forces._spec().outputs, op)
        self._fields_container: Output[FieldsContainer] = Output(
            reaction_forces._spec().output_pin(0), 0, op
        )
