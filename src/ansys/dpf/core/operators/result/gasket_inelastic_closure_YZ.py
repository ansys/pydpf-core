...
class gasket_inelastic_closure_YZ(Operator):
    """Read/compute elemental gasket inelastic closure YZ shear component (12
    ...
    >>> op = dpf.operators.result.gasket_inelastic_closure_YZ()
    ...
    def __init__(
        ...
        super().__init__(name="GKDIYZ", config=config, server=server)
        self._inputs = InputsGasketInelasticClosureYz(self)
        self._outputs = OutputsGasketInelasticClosureYz(self)
    ...
    @staticmethod
    def _spec():
        description = """Read/compute elemental gasket inelastic closure YZ shear component (12
    ...
    def default_config(server=None):
        ...
        """
        return Operator.default_config(name="GKDIYZ", server=server)
    ...
    def inputs(self):
        ...
        Returns
        --------
        inputs : InputsGasketInelasticClosureYz
        """
        return super().inputs
    ...
    def outputs(self):
        ...
        Returns
        --------
        outputs : OutputsGasketInelasticClosureYz
        """
        return super().outputs


class InputsGasketInelasticClosureYz(_Inputs):
    """Intermediate class used to connect user inputs to
    gasket_inelastic_closure_YZ operator.
    ...
    def __init__(self, op: Operator):
        super().__init__(gasket_inelastic_closure_YZ._spec().inputs, op)
        self._time_scoping = Input(
            gasket_inelastic_closure_YZ._spec().input_pin(0), 0, op, -1
        )
        self._inputs.append(self._time_scoping)
        self._mesh_scoping = Input(
            gasket_inelastic_closure_YZ._spec().input_pin(1), 1, op, -1
        )
        self._inputs.append(self._mesh_scoping)
        self._fields_container = Input(
            gasket_inelastic_closure_YZ._spec().input_pin(2), 2, op, -1
        )
        self._inputs.append(self._fields_container)
        self._streams_container = Input(
            gasket_inelastic_closure_YZ._spec().input_pin(3), 3, op, -1
        )
        self._inputs.append(self._streams_container)
        self._data_sources = Input(
            gasket_inelastic_closure_YZ._spec().input_pin(4), 4, op, -1
        )
        self._inputs.append(self._data_sources)
        self._bool_rotate_to_global = Input(
            gasket_inelastic_closure_YZ._spec().input_pin(5), 5, op, -1
        )
        self._inputs.append(self._bool_rotate_to_global)
        self._mesh = Input(gasket_inelastic_closure_YZ._spec().input_pin(7), 7, op, -1)
        self._inputs.append(self._mesh)
        self._requested_location = Input(
            gasket_inelastic_closure_YZ._spec().input_pin(9), 9, op, -1
        )
        self._inputs.append(self._requested_location)
        self._read_cyclic = Input(
            gasket_inelastic_closure_YZ._spec().input_pin(14), 14, op, -1
        )
        self._inputs.append(self._read_cyclic)
        self._read_beams = Input(
            gasket_inelastic_closure_YZ._spec().input_pin(22), 22, op, -1
        )
...
class OutputsGasketInelasticClosureYz(_Outputs):
    ...
    def __init__(self, op: Operator):
        super().__init__(gasket_inelastic_closure_YZ._spec().outputs, op)
        self._fields_container = Output(
            gasket_inelastic_closure_YZ._spec().output_pin(0), 0, op
        )
