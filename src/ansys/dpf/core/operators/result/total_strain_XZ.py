...
class total_strain_XZ(Operator):
    r"""Read/compute element nodal component total strains XZ shear component
    ...
    >>> op = dpf.operators.result.total_strain_XZ()
    ...
    def __init__(
        ...
        super().__init__(
            ...
            config=config,
            server=server,
            inputs_type=InputsTotalStrainXz,
            outputs_type=OutputsTotalStrainXz,
        )
    ...
    def _spec() -> Specification:
        description = r"""Read/compute element nodal component total strains XZ shear component
(02 component) by calling the readers defined by the datasources.
Regarding the requested location and the input mesh scoping, the result
location can be Nodal/ElementalNodal/Elemental.
"""
    ...
    def default_config(server: AnyServerType = None) -> Config:
        ...
        """
        return Operator.default_config(name="ELXZ", server=server)

    @property
    def inputs(self) -> InputsTotalStrainXz:
        """Enables to connect inputs to the operator

        Returns
        --------
        inputs:
            An instance of InputsTotalStrainXz.
        """
        return self._inputs

    @property
    def outputs(self) -> OutputsTotalStrainXz:
        """Enables to get outputs of the operator by evaluating it

        Returns
        --------
        outputs:
            An instance of OutputsTotalStrainXz.
        """
        return self._outputs


class InputsTotalStrainXz(_Inputs):
    """Intermediate class used to connect user inputs to
    total_strain_XZ operator.
...
class OutputsTotalStrainXz(_Outputs):
    ...
    def __init__(self, op: Operator):
        super().__init__(total_strain_XZ._spec().outputs, op)
        self._fields_container: Output[FieldsContainer] = Output(
            total_strain_XZ._spec().output_pin(0), 0, op
        )
