...
class thermal_strains_eqv(Operator):
    ...
    ‘requested_location’ and ‘mesh_scoping’ inputs are processed to infer if
    scoping transposition or result averaging is needed, with the resulting
    output fields having ‘Nodal’, ‘ElementalNodal’ or ‘Elemental’ location.
