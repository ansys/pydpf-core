...
class modal_velocity(Operator):
    ...
    _inputs: InputsModalVelocity
    _outputs: OutputsModalVelocity
...
class InputsModalVelocity(_Inputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._mesh_scoping: Input[ScopingsContainer | Scoping] = Input(
            modal_velocity._spec().input_pin(1), 1, op, -1
        )
        self._inputs.append(self._mesh_scoping)
        self._fields_container: Input[FieldsContainer] = Input(
            modal_velocity._spec().input_pin(2), 2, op, -1
        )
        ...
        self._mesh: Input[MeshedRegion | MeshesContainer] = Input(
            modal_velocity._spec().input_pin(7), 7, op, -1
        )
