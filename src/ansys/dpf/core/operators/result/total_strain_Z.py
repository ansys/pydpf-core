...
class total_strain_Z(Operator):
    r"""Read/compute element nodal component total strains ZZ normal component
    ...
    >>> op = dpf.operators.result.total_strain_Z()
    ...
    def __init__(
        ...
        super().__init__(
            ...
            config=config,
            server=server,
            inputs_type=InputsTotalStrainZ,
            outputs_type=OutputsTotalStrainZ,
        )
    ...
    def _spec() -> Specification:
        description = r"""Read/compute element nodal component total strains ZZ normal component
(22 component) by calling the readers defined by the datasources.
Regarding the requested location and the input mesh scoping, the result
location can be Nodal/ElementalNodal/Elemental.
"""
    ...
    def default_config(server: AnyServerType = None) -> Config:
        ...
        """
        return Operator.default_config(name="ELZ", server=server)

    @property
    def inputs(self) -> InputsTotalStrainZ:
        """Enables to connect inputs to the operator

        Returns
        --------
        inputs:
            An instance of InputsTotalStrainZ.
        """
        return self._inputs

    @property
    def outputs(self) -> OutputsTotalStrainZ:
        """Enables to get outputs of the operator by evaluating it

        Returns
        --------
        outputs:
            An instance of OutputsTotalStrainZ.
        """
        return self._outputs


class InputsTotalStrainZ(_Inputs):
    """Intermediate class used to connect user inputs to
    total_strain_Z operator.
...
class OutputsTotalStrainZ(_Outputs):
    ...
    def __init__(self, op: Operator):
        super().__init__(total_strain_Z._spec().outputs, op)
        self._fields_container: Output[FieldsContainer] = Output(
            total_strain_Z._spec().output_pin(0), 0, op
        )
