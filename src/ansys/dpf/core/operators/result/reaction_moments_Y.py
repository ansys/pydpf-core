...
class reaction_moments_Y(Operator):
    r"""Read/compute nodal reaction moments Y component of the vector (2nd
    ...
    >>> op = dpf.operators.result.reaction_moments_Y()
    ...
    def __init__(
        ...
        super().__init__(
            ...
            config=config,
            server=server,
            inputs_type=InputsReactionMomentsY,
            outputs_type=OutputsReactionMomentsY,
        )
    ...
    def _spec() -> Specification:
        description = r"""Read/compute nodal reaction moments Y component of the vector (2nd
component) by calling the readers defined by the datasources.
"""
        spec = Specification(
    ...
    def default_config(server: AnyServerType = None) -> Config:
        ...
        """
        return Operator.default_config(name="RF_MomentY", server=server)

    @property
    def inputs(self) -> InputsReactionMomentsY:
        """Enables to connect inputs to the operator

        Returns
        --------
        inputs:
            An instance of InputsReactionMomentsY.
        """
        return self._inputs

    @property
    def outputs(self) -> OutputsReactionMomentsY:
        """Enables to get outputs of the operator by evaluating it

        Returns
        --------
        outputs:
            An instance of OutputsReactionMomentsY.
        """
        return self._outputs


class InputsReactionMomentsY(_Inputs):
    """Intermediate class used to connect user inputs to
    reaction_moments_Y operator.
...
class OutputsReactionMomentsY(_Outputs):
    ...
    def __init__(self, op: Operator):
        super().__init__(reaction_moments_Y._spec().outputs, op)
        self._fields_container: Output[FieldsContainer] = Output(
            reaction_moments_Y._spec().output_pin(0), 0, op
        )
