...
class reaction_heat(Operator):
    r"""Read/compute nodal reaction heat by calling the readers defined by the
    datasources.
    ...
    >>> op = dpf.operators.result.reaction_heat()
    ...
    def __init__(
        ...
        super().__init__(
            ...
            config=config,
            server=server,
            inputs_type=InputsReactionHeat,
            outputs_type=OutputsReactionHeat,
        )
    ...
    def _spec() -> Specification:
        description = r"""Read/compute nodal reaction heat by calling the readers defined by the
datasources.
"""
        spec = Specification(
    ...
    def default_config(server: AnyServerType = None) -> Config:
        ...
        """
        return Operator.default_config(name="RF_Heat", server=server)

    @property
    def inputs(self) -> InputsReactionHeat:
        """Enables to connect inputs to the operator

        Returns
        --------
        inputs:
            An instance of InputsReactionHeat.
        """
        return self._inputs

    @property
    def outputs(self) -> OutputsReactionHeat:
        """Enables to get outputs of the operator by evaluating it

        Returns
        --------
        outputs:
            An instance of OutputsReactionHeat.
        """
        return self._outputs


class InputsReactionHeat(_Inputs):
    """Intermediate class used to connect user inputs to
    reaction_heat operator.
...
class OutputsReactionHeat(_Outputs):
    ...
    def __init__(self, op: Operator):
        super().__init__(reaction_heat._spec().outputs, op)
        self._fields_container: Output[FieldsContainer] = Output(
            reaction_heat._spec().output_pin(0), 0, op
        )
