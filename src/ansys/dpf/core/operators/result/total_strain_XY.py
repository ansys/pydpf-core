...
class total_strain_XY(Operator):
    r"""Read/compute element nodal component total strains XY shear component
    ...
    >>> op = dpf.operators.result.total_strain_XY()
    ...
    def __init__(
        ...
        super().__init__(
            ...
            config=config,
            server=server,
            inputs_type=InputsTotalStrainXy,
            outputs_type=OutputsTotalStrainXy,
        )
    ...
    def _spec() -> Specification:
        description = r"""Read/compute element nodal component total strains XY shear component
(01 component) by calling the readers defined by the datasources.
Regarding the requested location and the input mesh scoping, the result
location can be Nodal/ElementalNodal/Elemental.
"""
    ...
    def default_config(server: AnyServerType = None) -> Config:
        ...
        """
        return Operator.default_config(name="ELXY", server=server)

    @property
    def inputs(self) -> InputsTotalStrainXy:
        """Enables to connect inputs to the operator

        Returns
        --------
        inputs:
            An instance of InputsTotalStrainXy.
        """
        return self._inputs

    @property
    def outputs(self) -> OutputsTotalStrainXy:
        """Enables to get outputs of the operator by evaluating it

        Returns
        --------
        outputs:
            An instance of OutputsTotalStrainXy.
        """
        return self._outputs


class InputsTotalStrainXy(_Inputs):
    """Intermediate class used to connect user inputs to
    total_strain_XY operator.
...
class OutputsTotalStrainXy(_Outputs):
    ...
    def __init__(self, op: Operator):
        super().__init__(total_strain_XY._spec().outputs, op)
        self._fields_container: Output[FieldsContainer] = Output(
            total_strain_XY._spec().output_pin(0), 0, op
        )
