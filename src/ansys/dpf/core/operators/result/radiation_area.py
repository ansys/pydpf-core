...
class radiation_area(Operator):
    r"""Read/compute radiation area by calling the readers defined by the
    datasources.
    ...
    >>> op = dpf.operators.result.radiation_area()
    ...
    def __init__(
        ...
        super().__init__(
            ...
            config=config,
            server=server,
            inputs_type=InputsRadiationArea,
            outputs_type=OutputsRadiationArea,
        )
    ...
    def _spec() -> Specification:
        description = r"""Read/compute radiation area by calling the readers defined by the
datasources.
"""
        spec = Specification(
    ...
    def default_config(server: AnyServerType = None) -> Config:
        ...
        """
        return Operator.default_config(name="RadiationArea", server=server)

    @property
    def inputs(self) -> InputsRadiationArea:
        """Enables to connect inputs to the operator

        Returns
        --------
        inputs:
            An instance of InputsRadiationArea.
        """
        return self._inputs

    @property
    def outputs(self) -> OutputsRadiationArea:
        """Enables to get outputs of the operator by evaluating it

        Returns
        --------
        outputs:
            An instance of OutputsRadiationArea.
        """
        return self._outputs


class InputsRadiationArea(_Inputs):
    """Intermediate class used to connect user inputs to
    radiation_area operator.
...
class OutputsRadiationArea(_Outputs):
    ...
    def __init__(self, op: Operator):
        super().__init__(radiation_area._spec().outputs, op)
        self._fields_container: Output[FieldsContainer] = Output(
            radiation_area._spec().output_pin(0), 0, op
        )
