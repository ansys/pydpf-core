...
class reaction_moment_Z(Operator):
    ...
    >>> op = dpf.operators.result.reaction_moment_Z()
    ...
    def __init__(
        ...
        super().__init__(
            ...
            config=config,
            server=server,
            inputs_type=InputsReactionMomentZ,
            outputs_type=OutputsReactionMomentZ,
        )
...
"""
    ...
    @property
    def inputs(self) -> InputsReactionMomentZ:
        """Enables to connect inputs to the operator

        Returns
        --------
        inputs:
            An instance of InputsReactionMomentZ.
        """
        return self._inputs

    @property
    def outputs(self) -> OutputsReactionMomentZ:
        """Enables to get outputs of the operator by evaluating it

        Returns
        --------
        outputs:
            An instance of OutputsReactionMomentZ.
        """
        return self._outputs


class InputsReactionMomentZ(_Inputs):
    """Intermediate class used to connect user inputs to
    reaction_moment_Z operator.
...
class OutputsReactionMomentZ(_Outputs):
    ...
    def __init__(self, op: Operator):
        super().__init__(reaction_moment_Z._spec().outputs, op)
        self._fields_container: Output[FieldsContainer] = Output(
            reaction_moment_Z._spec().output_pin(0), 0, op
        )
