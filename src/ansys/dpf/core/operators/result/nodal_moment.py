...
class InputsNodalMoment(_Inputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._mesh: Input[MeshedRegion | MeshesContainer] = Input(
            nodal_moment._spec().input_pin(7), 7, op, -1
        )
...
class OutputsNodalMoment(_Outputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._fields_container: Output[FieldsContainer] = Output(
            nodal_moment._spec().output_pin(0), 0, op
        )
