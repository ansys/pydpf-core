...
class mean_div_lighthill_tensor(Operator):
    """Read Mean of the divergence of the Lighthill Tensor by calling the
    ...
    >>> op = dpf.operators.result.mean_div_lighthill_tensor()
    ...
    def __init__(
        ...
        super().__init__(name="SV_RTDFT_A", config=config, server=server)
        self._inputs = InputsMeanDivLighthillTensor(self)
        self._outputs = OutputsMeanDivLighthillTensor(self)
    ...
    @staticmethod
    def _spec():
        description = """Read Mean of the divergence of the Lighthill Tensor by calling the
            readers defined by the datasources."""
        spec = Specification(
    ...
    def default_config(server=None):
        ...
        """
        return Operator.default_config(name="SV_RTDFT_A", server=server)
    ...
    def inputs(self):
        ...
        Returns
        --------
        inputs : InputsMeanDivLighthillTensor
        """
        return super().inputs
    ...
    def outputs(self):
        ...
        Returns
        --------
        outputs : OutputsMeanDivLighthillTensor
        """
        return super().outputs


class InputsMeanDivLighthillTensor(_Inputs):
    """Intermediate class used to connect user inputs to
    mean_div_lighthill_tensor operator.
    ...
    def __init__(self, op: Operator):
        super().__init__(mean_div_lighthill_tensor._spec().inputs, op)
        self._time_scoping = Input(
            mean_div_lighthill_tensor._spec().input_pin(0), 0, op, -1
        )
        self._inputs.append(self._time_scoping)
        self._mesh_scoping = Input(
            mean_div_lighthill_tensor._spec().input_pin(1), 1, op, -1
        )
        self._inputs.append(self._mesh_scoping)
        self._streams_container = Input(
            mean_div_lighthill_tensor._spec().input_pin(3), 3, op, -1
        )
        self._inputs.append(self._streams_container)
        self._data_sources = Input(
            mean_div_lighthill_tensor._spec().input_pin(4), 4, op, -1
        )
        self._inputs.append(self._data_sources)
        self._mesh = Input(mean_div_lighthill_tensor._spec().input_pin(7), 7, op, -1)
        self._inputs.append(self._mesh)
        self._region_scoping = Input(
            mean_div_lighthill_tensor._spec().input_pin(25), 25, op, -1
        )
        self._inputs.append(self._region_scoping)
        self._qualifiers1 = Input(
            mean_div_lighthill_tensor._spec().input_pin(1000), 1000, op, 0
        )
        self._inputs.append(self._qualifiers1)
        self._qualifiers2 = Input(
            mean_div_lighthill_tensor._spec().input_pin(1001), 1001, op, 1
        )
...
class OutputsMeanDivLighthillTensor(_Outputs):
    ...
    def __init__(self, op: Operator):
        super().__init__(mean_div_lighthill_tensor._spec().outputs, op)
        self._fields_container = Output(
            mean_div_lighthill_tensor._spec().output_pin(0), 0, op
        )
