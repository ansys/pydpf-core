...
class Pressure(Operator):
    ...
    def __init__(
        ...
        super().__init__(name="cgns::cgns::Pressure", config=config, server=server)
    ...
    def default_config(server=None):
        ...
        """
        return Operator.default_config(name="cgns::cgns::Pressure", server=server)
...
class InputsPressure(_Inputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._result_name = Input(Pressure._spec().input_pin(17), 17, op, -1)
...
class OutputsPressure(_Outputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._fields = Output(Pressure._spec().output_pin(0), 0, op)
