...
class reaction_moment(Operator):
    ...
    >>> op = dpf.operators.result.reaction_moment()
    ...
    def __init__(
        ...
        super().__init__(
            ...
            config=config,
            server=server,
            inputs_type=InputsReactionMoment,
            outputs_type=OutputsReactionMoment,
        )
...
"""
    ...
    @property
    def inputs(self) -> InputsReactionMoment:
        """Enables to connect inputs to the operator

        Returns
        --------
        inputs:
            An instance of InputsReactionMoment.
        """
        return self._inputs

    @property
    def outputs(self) -> OutputsReactionMoment:
        """Enables to get outputs of the operator by evaluating it

        Returns
        --------
        outputs:
            An instance of OutputsReactionMoment.
        """
        return self._outputs


class InputsReactionMoment(_Inputs):
    """Intermediate class used to connect user inputs to
    reaction_moment operator.
...
class OutputsReactionMoment(_Outputs):
    ...
    def __init__(self, op: Operator):
        super().__init__(reaction_moment._spec().outputs, op)
        self._fields_container: Output[FieldsContainer] = Output(
            reaction_moment._spec().output_pin(0), 0, op
        )
