...
class create_mech_kriging_workflow(Operator):
    ...
    >>> op = dpf.operators.mapping.create_mech_kriging_workflow()
    ...
    def __init__(
        ...
        super().__init__(name="mech_kriging_wf", config=config, server=server)
        self._inputs = InputsCreateMechKrigingWorkflow(self)
        self._outputs = OutputsCreateMechKrigingWorkflow(self)
    ...
    def default_config(server=None):
        ...
        """
        return Operator.default_config(name="mech_kriging_wf", server=server)
    ...
    def inputs(self):
        ...
        Returns
        --------
        inputs : InputsCreateMechKrigingWorkflow
        """
        return super().inputs
    ...
    def outputs(self):
        ...
        Returns
        --------
        outputs : OutputsCreateMechKrigingWorkflow
        """
        return super().outputs


class InputsCreateMechKrigingWorkflow(_Inputs):
    """Intermediate class used to connect user inputs to
    create_mech_kriging_workflow operator.
    ...
    def __init__(self, op: Operator):
        super().__init__(create_mech_kriging_workflow._spec().inputs, op)
        self._source_mesh = Input(
            create_mech_kriging_workflow._spec().input_pin(0), 0, op, -1
        )
        self._inputs.append(self._source_mesh)
        self._target_mesh = Input(
            create_mech_kriging_workflow._spec().input_pin(1), 1, op, -1
        )
        self._inputs.append(self._target_mesh)
        self._target_scoping = Input(
            create_mech_kriging_workflow._spec().input_pin(6), 6, op, -1
        )
        self._inputs.append(self._target_scoping)
        self._options_data_tree = Input(
            create_mech_kriging_workflow._spec().input_pin(10), 10, op, -1
        )
...
class OutputsCreateMechKrigingWorkflow(_Outputs):
    ...
    def __init__(self, op: Operator):
        super().__init__(create_mech_kriging_workflow._spec().outputs, op)
        self._mapping_workflow = Output(
            create_mech_kriging_workflow._spec().output_pin(0), 0, op
        )
