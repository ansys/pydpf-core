...
class create_mech_shape_func_vol_workflow(Operator):
    ...
    >>> op = dpf.operators.mapping.create_mech_shape_func_vol_workflow()
    ...
    def __init__(
        ...
        super().__init__(
            name="mech_shape_function_vol_wf", config=config, server=server
        )
        self._inputs = InputsCreateMechShapeFuncVolWorkflow(self)
        self._outputs = OutputsCreateMechShapeFuncVolWorkflow(self)
    ...
    def default_config(server=None):
        ...
        """
        return Operator.default_config(name="mech_shape_function_vol_wf", server=server)
    ...
    def inputs(self):
        ...
        Returns
        --------
        inputs : InputsCreateMechShapeFuncVolWorkflow
        """
        return super().inputs
    ...
    def outputs(self):
        ...
        Returns
        --------
        outputs : OutputsCreateMechShapeFuncVolWorkflow
        """
        return super().outputs


class InputsCreateMechShapeFuncVolWorkflow(_Inputs):
    """Intermediate class used to connect user inputs to
    create_mech_shape_func_vol_workflow operator.
    ...
    def __init__(self, op: Operator):
        super().__init__(create_mech_shape_func_vol_workflow._spec().inputs, op)
        self._source_mesh = Input(
            create_mech_shape_func_vol_workflow._spec().input_pin(0), 0, op, -1
        )
        self._inputs.append(self._source_mesh)
        self._target_mesh = Input(
            create_mech_shape_func_vol_workflow._spec().input_pin(1), 1, op, -1
        )
        self._inputs.append(self._target_mesh)
        self._target_scoping = Input(
            create_mech_shape_func_vol_workflow._spec().input_pin(6), 6, op, -1
        )
        self._inputs.append(self._target_scoping)
        self._options_data_tree = Input(
            create_mech_shape_func_vol_workflow._spec().input_pin(10), 10, op, -1
        )
...
class OutputsCreateMechShapeFuncVolWorkflow(_Outputs):
    ...
    def __init__(self, op: Operator):
        super().__init__(create_mech_shape_func_vol_workflow._spec().outputs, op)
        self._mapping_workflow = Output(
            create_mech_shape_func_vol_workflow._spec().output_pin(0), 0, op
        )
