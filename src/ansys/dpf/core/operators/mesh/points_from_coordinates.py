...
class points_from_coordinates(Operator):
    ...
    def default_config(server=None):
        ...
        """
        return Operator.default_config(name="mesh::points_from_coordinates", server=server)
...
class OutputsPointsFromCoordinates(_Outputs):
    ...
    def __init__(self, op: Operator):
        ...
        self._abstract_meshed_region = Output(points_from_coordinates._spec().output_pin(0), 0, op)
