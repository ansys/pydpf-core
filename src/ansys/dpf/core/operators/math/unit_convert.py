...
from ansys.dpf.core.outputs import Output, _modify_output_spec_with_one_type, _Outputs
...
class OutputsUnitConvert(_Outputs):
    ...
    def __init__(self, op: Operator):
        ...
        self.converted_entity_as_field = Output(
            _modify_output_spec_with_one_type(unit_convert._spec().output_pin(0), "field"),
            0,
            op,
        )
        ...
        self.converted_entity_as_meshed_region = Output(
            _modify_output_spec_with_one_type(unit_convert._spec().output_pin(0), "meshed_region"),
            0,
            op,
        )
