...
""",
                             map_input_pin_spec={
                                 0 : PinSpecification(name = "fields_container", type_names=["fields_container"], optional=False, document="""Fields container representing the matrix $A$. May be real or complex (complex label required for complex systems)."""), 
                                 1 : PinSpecification(name = "rhs", type_names=["fields_container"], optional=False, document="""Fields container representing the right-hand side $b$. Must have the same number of rows as $A$ and matching label structure.""")},
                             map_output_pin_spec={
                                 0 : PinSpecification(name = "fields_container", type_names=["fields_container"], optional=False, document="""Solution fields container $x$ satisfying $A x \approx b$. Same label structure as the input. Unit is (unit of $b$) / (unit of $A$).""")})
        return spec
...
class InputsQrSolve(_Inputs):
    ...
    def fields_container(self):
        ...
        - pindoc: Fields container representing the matrix $A$. May be real or complex (complex label required for complex systems).
    ...
    def rhs(self):
        ...
        - pindoc: Fields container representing the right-hand side $b$. Must have the same number of rows as $A$ and matching label structure.
...
class OutputsQrSolve(_Outputs):
    ...
    def fields_container(self):
        ...
        - pindoc: Solution fields container $x$ satisfying $A x \approx b$. Same label structure as the input. Unit is (unit of $b$) / (unit of $A$).
