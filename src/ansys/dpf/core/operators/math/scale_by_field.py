...
class scale_by_field(Operator):
    ...
    @staticmethod
    def _spec():
        spec = Specification(description="""Scales a field (in 0) by a scalar field (in 1). If one field's scoping has an 'overall' location, then this field's values are applied on the other field entirely.""",
                             map_input_pin_spec={
