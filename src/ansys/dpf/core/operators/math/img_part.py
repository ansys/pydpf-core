...
class img_part(Operator):
    r"""Extracts the imaginary-part fields (complex label 1) from a
    complex-valued fields container. The output container preserves all
    labels except the complex label.
    ...
    def _spec() -> Specification:
        description = r"""Extracts the imaginary-part fields (complex label 1) from a
complex-valued fields container. The output container preserves all
labels except the complex label.
"""
        spec = Specification(
            ...
            map_output_pin_spec={
                0: PinSpecification(
                    ...
                    type_names=["fields_container"],
                    optional=False,
                    document=r"""Fields container containing only the imaginary-part fields, without the complex label.""",
                ),
            },
        )
        return spec
