...
from ansys.dpf.core.gate.generated import scoping_abstract_api
...
class ScopingCAPI(scoping_abstract_api.ScopingAbstractAPI):
    ...
    def scoping_new_with_data(location, ids, size):
        errorSize = ctypes.c_int(0)
        sError = ctypes.c_wchar_p()
        res = capi.dll.Scoping_new_WithData(
    ...
    def scoping_get_data(scoping, location, size):
        errorSize = ctypes.c_int(0)
        sError = ctypes.c_wchar_p()
        res = capi.dll.Scoping_GetData(
            scoping._internal_obj if scoping is not None else None,
            utils.to_char_ptr_ptr(location),
    ...
    def scoping_get_ids_for_dpf_vector(scoping, out, data, size):
        errorSize = ctypes.c_int(0)
        sError = ctypes.c_wchar_p()
        res = capi.dll.Scoping_GetIds_For_DpfVector(
            scoping._internal_obj if scoping is not None else None,
            out._internal_obj,
    ...
    def scoping_set_location(scoping, location):
        errorSize = ctypes.c_int(0)
        sError = ctypes.c_wchar_p()
        res = capi.dll.Scoping_SetLocation(
            scoping._internal_obj if scoping is not None else None,
            utils.to_char_ptr(location),
            ctypes.byref(utils.to_int32(errorSize)),
            ctypes.byref(sError),
    ...
    def scoping_get_location(scoping):
        errorSize = ctypes.c_int(0)
        sError = ctypes.c_wchar_p()
        res = capi.dll.Scoping_GetLocation(
            scoping._internal_obj if scoping is not None else None,
            ctypes.byref(utils.to_int32(errorSize)),
            ctypes.byref(sError),
        )
    ...
    def scoping_set_entity(scoping, id, index):
        errorSize = ctypes.c_int(0)
        sError = ctypes.c_wchar_p()
        res = capi.dll.Scoping_SetEntity(
            scoping._internal_obj if scoping is not None else None,
            utils.to_int32(id),
    ...
    def scoping_id_by_index(scoping, index):
        errorSize = ctypes.c_int(0)
        sError = ctypes.c_wchar_p()
        res = capi.dll.Scoping_IdByIndex(
            scoping._internal_obj if scoping is not None else None,
            utils.to_int32(index),
            ctypes.byref(utils.to_int32(errorSize)),
            ctypes.byref(sError),
    ...
    def scoping_index_by_id(scoping, id):
        errorSize = ctypes.c_int(0)
        sError = ctypes.c_wchar_p()
        res = capi.dll.Scoping_IndexById(
            scoping._internal_obj if scoping is not None else None,
            utils.to_int32(id),
            ctypes.byref(utils.to_int32(errorSize)),
            ctypes.byref(sError),
    ...
    def scoping_get_ids_hash(scoping, hash):
        errorSize = ctypes.c_int(0)
        sError = ctypes.c_wchar_p()
        res = capi.dll.Scoping_GetIdsHash(
            scoping._internal_obj if scoping is not None else None,
            utils.to_char_ptr(hash),
            ctypes.byref(utils.to_int32(errorSize)),
            ctypes.byref(sError),
        )
        if errorSize.value != 0:
    ...
    def scoping_fast_access_ptr(scoping):
        errorSize = ctypes.c_int(0)
        sError = ctypes.c_wchar_p()
        res = capi.dll.Scoping_fast_access_ptr(
            scoping._internal_obj if scoping is not None else None,
            ctypes.byref(utils.to_int32(errorSize)),
            ctypes.byref(sError),
        )
    ...
    def scoping_new_on_client(client):
        errorSize = ctypes.c_int(0)
        sError = ctypes.c_wchar_p()
        res = capi.dll.Scoping_new_on_client(
