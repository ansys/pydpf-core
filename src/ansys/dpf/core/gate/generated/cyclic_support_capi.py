...
class CyclicSupportCAPI(cyclic_support_abstract_api.CyclicSupportAbstractAPI):
    ...
    def cyclic_support_delete(support):
        ...
        res = capi.dll.CyclicSupport_delete(
    ...
    def cyclic_support_get_num_sectors(support, istage):
        errorSize = ctypes.c_int(0)
        sError = ctypes.c_wchar_p()
        res = capi.dll.CyclicSupport_getNumSectors(
            support._internal_obj if support is not None else None,
            utils.to_int32(istage),
            ctypes.byref(utils.to_int32(errorSize)),
            ctypes.byref(sError),
        )
        if errorSize.value != 0:
    ...
    def cyclic_support_get_num_stages(support):
        errorSize = ctypes.c_int(0)
        sError = ctypes.c_wchar_p()
        res = capi.dll.CyclicSupport_getNumStages(
            support._internal_obj if support is not None else None,
            ctypes.byref(utils.to_int32(errorSize)),
            ctypes.byref(sError),
        )
    ...
    def cyclic_support_get_sectors_scoping(support, istage):
        errorSize = ctypes.c_int(0)
        sError = ctypes.c_wchar_p()
        res = capi.dll.CyclicSupport_getSectorsScoping(
            support._internal_obj if support is not None else None,
            utils.to_int32(istage),
            ctypes.byref(utils.to_int32(errorSize)),
            ctypes.byref(sError),
    ...
    def cyclic_support_get_cyclic_phase(support):
        errorSize = ctypes.c_int(0)
        sError = ctypes.c_wchar_p()
        res = capi.dll.CyclicSupport_getCyclicPhase(
            support._internal_obj if support is not None else None,
            ctypes.byref(utils.to_int32(errorSize)),
            ctypes.byref(sError),
        )
    ...
    def cyclic_support_get_base_nodes_scoping(support, istage):
        errorSize = ctypes.c_int(0)
        sError = ctypes.c_wchar_p()
        res = capi.dll.CyclicSupport_getBaseNodesScoping(
            support._internal_obj if support is not None else None,
            utils.to_int32(istage),
            ctypes.byref(utils.to_int32(errorSize)),
            ctypes.byref(sError),
    ...
    def cyclic_support_get_base_elements_scoping(support, istage):
        errorSize = ctypes.c_int(0)
        sError = ctypes.c_wchar_p()
        res = capi.dll.CyclicSupport_getBaseElementsScoping(
            support._internal_obj if support is not None else None,
            utils.to_int32(istage),
            ctypes.byref(utils.to_int32(errorSize)),
            ctypes.byref(sError),
    ...
    def cyclic_support_get_expanded_node_ids(support, baseNodeId, istage, sectorsScoping):
        errorSize = ctypes.c_int(0)
        sError = ctypes.c_wchar_p()
        res = capi.dll.CyclicSupport_getExpandedNodeIds(
            support._internal_obj if support is not None else None,
            utils.to_int32(baseNodeId),
            utils.to_int32(istage),
            sectorsScoping._internal_obj if sectorsScoping is not None else None,
            ctypes.byref(utils.to_int32(errorSize)),
            ctypes.byref(sError),
        )
        if errorSize.value != 0:
    ...
    def cyclic_support_get_expanded_element_ids(support, baseElementId, istage, sectorsScoping):
        errorSize = ctypes.c_int(0)
        sError = ctypes.c_wchar_p()
        res = capi.dll.CyclicSupport_getExpandedElementIds(
            support._internal_obj if support is not None else None,
            utils.to_int32(baseElementId),
            utils.to_int32(istage),
            sectorsScoping._internal_obj if sectorsScoping is not None else None,
            ctypes.byref(utils.to_int32(errorSize)),
            ctypes.byref(sError),
    ...
    def cyclic_support_get_cs(support):
        errorSize = ctypes.c_int(0)
        sError = ctypes.c_wchar_p()
        res = capi.dll.CyclicSupport_getCS(
            support._internal_obj if support is not None else None,
            ctypes.byref(utils.to_int32(errorSize)),
            ctypes.byref(sError),
        )
    ...
    def cyclic_support_get_low_high_map(support, istage):
        errorSize = ctypes.c_int(0)
        sError = ctypes.c_wchar_p()
        res = capi.dll.CyclicSupport_getLowHighMap(
            support._internal_obj if support is not None else None,
            utils.to_int32(istage),
            ctypes.byref(utils.to_int32(errorSize)),
            ctypes.byref(sError),
    ...
    def cyclic_support_get_high_low_map(support, istage):
        errorSize = ctypes.c_int(0)
        sError = ctypes.c_wchar_p()
        res = capi.dll.CyclicSupport_getHighLowMap(
            support._internal_obj if support is not None else None,
            utils.to_int32(istage),
            ctypes.byref(utils.to_int32(errorSize)),
            ctypes.byref(sError),
