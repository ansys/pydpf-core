...
from ansys.dpf.core.gate.generated import string_field_abstract_api
...
class StringFieldCAPI(string_field_abstract_api.StringFieldAbstractAPI):
    ...
    def string_field_delete(field):
        ...
        res = capi.dll.StringField_Delete(
    ...
    def string_field_get_entity_data(field, EntityIndex):
        errorSize = ctypes.c_int(0)
        sError = ctypes.c_wchar_p()
        res = capi.dll.StringField_GetEntityData(
            field,
    ...
    def string_field_get_number_entities(field):
        errorSize = ctypes.c_int(0)
        sError = ctypes.c_wchar_p()
        res = capi.dll.StringField_GetNumberEntities(
            field, ctypes.byref(utils.to_int32(errorSize)), ctypes.byref(sError)
        )
        if errorSize.value != 0:
            raise errors.DPFServerException(sError.value)
    ...
    def csstring_field_new(numEntities, data_size):
        errorSize = ctypes.c_int(0)
        sError = ctypes.c_wchar_p()
        res = capi.dll.CSStringField_new(
    ...
    def csstring_field_get_data_for_dpf_vector(field, out, data, size):
        errorSize = ctypes.c_int(0)
        sError = ctypes.c_wchar_p()
        res = capi.dll.CSStringField_GetData_For_DpfVector(
            field._internal_obj if field is not None else None,
            out._internal_obj,
            utils.to_char_ptr_ptr_ptr(data),
    ...
    def csstring_field_get_entity_data_for_dpf_vector(dpf_object, out, data, size, EntityIndex):
        errorSize = ctypes.c_int(0)
        sError = ctypes.c_wchar_p()
        res = capi.dll.CSStringField_GetEntityData_For_DpfVector(
    ...
    def csstring_field_get_entity_data_by_id_for_dpf_vector(dpf_object, vec, data, size, EntityId):
        errorSize = ctypes.c_int(0)
        sError = ctypes.c_wchar_p()
        res = capi.dll.CSStringField_GetEntityDataById_For_DpfVector(
            dpf_object._internal_obj if dpf_object is not None else None,
            vec._internal_obj,
            utils.to_char_ptr_ptr_ptr(data),
            utils.to_int32_ptr(size),
    ...
    def csstring_field_get_cscoping(field):
        errorSize = ctypes.c_int(0)
        sError = ctypes.c_wchar_p()
        res = capi.dll.CSStringField_GetCScoping(
            field._internal_obj if field is not None else None,
            ctypes.byref(utils.to_int32(errorSize)),
            ctypes.byref(sError),
        )
    ...
    def csstring_field_get_data_size(field):
        errorSize = ctypes.c_int(0)
        sError = ctypes.c_wchar_p()
        res = capi.dll.CSStringField_GetDataSize(
            field._internal_obj if field is not None else None,
            ctypes.byref(utils.to_int32(errorSize)),
            ctypes.byref(sError),
        )
    ...
    def csstring_field_set_data(field, size, data):
        errorSize = ctypes.c_int(0)
        sError = ctypes.c_wchar_p()
        res = capi.dll.CSStringField_SetData(
            field._internal_obj if field is not None else None,
            utils.to_int32(size),
    ...
    def csstring_field_set_cscoping(field, scoping):
        errorSize = ctypes.c_int(0)
        sError = ctypes.c_wchar_p()
        res = capi.dll.CSStringField_SetCScoping(
            field._internal_obj if field is not None else None,
    ...
    def csstring_field_push_back(field, EntityId, size, data):
        errorSize = ctypes.c_int(0)
        sError = ctypes.c_wchar_p()
        res = capi.dll.CSStringField_PushBack(
            field._internal_obj if field is not None else None,
            utils.to_int32(EntityId),
            utils.to_int32(size),
            utils.to_char_ptr_ptr(data),
    ...
    def csstring_field_resize(field, dataSize, scopingSize):
        errorSize = ctypes.c_int(0)
        sError = ctypes.c_wchar_p()
        res = capi.dll.CSStringField_Resize(
            field._internal_obj if field is not None else None,
    ...
    def csstring_field_reserve(field, dataSize, scopingSize):
        errorSize = ctypes.c_int(0)
        sError = ctypes.c_wchar_p()
        res = capi.dll.CSStringField_Reserve(
            field._internal_obj if field is not None else None,
            utils.to_int32(dataSize),
            utils.to_int32(scopingSize),
            ctypes.byref(utils.to_int32(errorSize)),
    ...
    def csstring_field_new_on_client(client, numEntities, data_size):
        errorSize = ctypes.c_int(0)
        sError = ctypes.c_wchar_p()
        res = capi.dll.CSStringField_new_on_client(
