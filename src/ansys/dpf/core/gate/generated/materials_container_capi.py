...
from ansys.dpf.core.gate.generated import materials_container_abstract_api
...
class MaterialsContainerCAPI(materials_container_abstract_api.MaterialsContainerAbstractAPI):
    ...
    def materials_container_delete(materialscontainer):
        ...
        res = capi.dll.MaterialsContainer_delete(
            materialscontainer._internal_obj if materialscontainer is not None else None,
    ...
    def materials_container_get_dpf_mat_ids(materialscontainer, size):
        errorSize = ctypes.c_int(0)
        sError = ctypes.c_wchar_p()
        res = capi.dll.MaterialsContainer_GetDpfMatIds(
            materialscontainer._internal_obj if materialscontainer is not None else None,
    ...
    def materials_container_get_vuuidat_dpf_mat_id(materialscontainer, dpfMatId):
        errorSize = ctypes.c_int(0)
        sError = ctypes.c_wchar_p()
        res = capi.dll.MaterialsContainer_GetVUUIDAtDpfMatId(
            materialscontainer._internal_obj if materialscontainer is not None else None,
            utils.to_int32(dpfMatId),
            ctypes.byref(utils.to_int32(errorSize)),
            ctypes.byref(sError),
        )
        if errorSize.value != 0:
    ...
    def materials_container_get_num_of_materials(materialscontainer):
        errorSize = ctypes.c_int(0)
        sError = ctypes.c_wchar_p()
        res = capi.dll.MaterialsContainer_GetNumOfMaterials(
            materialscontainer._internal_obj if materialscontainer is not None else None,
            ctypes.byref(utils.to_int32(errorSize)),
            ctypes.byref(sError),
        )
    ...
    def materials_container_get_num_available_properties_at_vuuid(materialscontainer, vuuid):
        errorSize = ctypes.c_int(0)
        sError = ctypes.c_wchar_p()
        res = capi.dll.MaterialsContainer_GetNumAvailablePropertiesAtVUUID(
            materialscontainer._internal_obj if materialscontainer is not None else None,
            utils.to_char_ptr(vuuid),
            ctypes.byref(utils.to_int32(errorSize)),
            ctypes.byref(sError),
        )
        if errorSize.value != 0:
    ...
    @staticmethod
    def materials_container_get_property_scripting_name_of_dpf_mat_id_at_index(
        materialscontainer, dpfmatID, idx
    ):
        errorSize = ctypes.c_int(0)
        sError = ctypes.c_wchar_p()
        res = capi.dll.MaterialsContainer_GetPropertyScriptingNameOfDpfMatIdAtIndex(
            materialscontainer._internal_obj if materialscontainer is not None else None,
            utils.to_int32(dpfmatID),
            utils.to_int32(idx),
            ctypes.byref(utils.to_int32(errorSize)),
    ...
    @staticmethod
    def materials_container_get_num_available_properties_at_dpf_mat_id(
        materialscontainer, dpfmatID
    ):
        errorSize = ctypes.c_int(0)
        sError = ctypes.c_wchar_p()
        res = capi.dll.MaterialsContainer_GetNumAvailablePropertiesAtDpfMatId(
            materialscontainer._internal_obj if materialscontainer is not None else None,
            utils.to_int32(dpfmatID),
            ctypes.byref(utils.to_int32(errorSize)),
            ctypes.byref(sError),
    ...
    def materials_container_get_material_physic_name_at_vuuid(materialscontainer, vuuid):
        errorSize = ctypes.c_int(0)
        sError = ctypes.c_wchar_p()
        res = capi.dll.MaterialsContainer_GetMaterialPhysicNameAtVUUID(
            materialscontainer._internal_obj if materialscontainer is not None else None,
            utils.to_char_ptr(vuuid),
            ctypes.byref(utils.to_int32(errorSize)),
            ctypes.byref(sError),
    ...
    def materials_container_get_material_physic_name_at_dpf_mat_id(materialscontainer, dpfmatID):
        errorSize = ctypes.c_int(0)
        sError = ctypes.c_wchar_p()
        res = capi.dll.MaterialsContainer_GetMaterialPhysicNameAtDpfMatId(
            materialscontainer._internal_obj if materialscontainer is not None else None,
            utils.to_int32(dpfmatID),
            ctypes.byref(utils.to_int32(errorSize)),
            ctypes.byref(sError),
    ...
    def materials_container_get_dpf_mat_id_at_material_physic_name(materialscontainer, physicname):
        errorSize = ctypes.c_int(0)
        sError = ctypes.c_wchar_p()
        res = capi.dll.MaterialsContainer_GetDpfMatIdAtMaterialPhysicName(
            materialscontainer._internal_obj if materialscontainer is not None else None,
            utils.to_char_ptr(physicname),
            ctypes.byref(utils.to_int32(errorSize)),
            ctypes.byref(sError),
        )
        if errorSize.value != 0:
    ...
    def materials_container_get_dpf_mat_id_at_vuuid(materialscontainer, vuuid):
        errorSize = ctypes.c_int(0)
        sError = ctypes.c_wchar_p()
        res = capi.dll.MaterialsContainer_GetDpfMatIdAtVUUID(
            materialscontainer._internal_obj if materialscontainer is not None else None,
            utils.to_char_ptr(vuuid),
            ctypes.byref(utils.to_int32(errorSize)),
            ctypes.byref(sError),
