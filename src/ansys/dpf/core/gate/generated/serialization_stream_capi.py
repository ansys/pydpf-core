...
from ansys.dpf.core.gate.generated import serialization_stream_abstract_api
...
class SerializationStreamCAPI(serialization_stream_abstract_api.SerializationStreamAbstractAPI):
    ...
    def serialization_stream_get_output_string(stream, dataSize):
        ...
        res = capi.dll.SerializationStream_getOutputString(
            stream._internal_obj if stream is not None else None,
            dataSize,
