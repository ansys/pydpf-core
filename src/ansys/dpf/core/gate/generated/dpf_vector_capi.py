...
from ansys.dpf.core.gate.generated import dpf_vector_abstract_api
...
class DpfVectorCAPI(dpf_vector_abstract_api.DpfVectorAbstractAPI):
    ...
    def dpf_vector_double_free(dpf_vector, data, size, modified):
        errorSize = ctypes.c_int(0)
        sError = ctypes.c_wchar_p()
        res = capi.dll.DpfVector_double_free(
            dpf_vector._internal_obj,
    ...
    def dpf_vector_char_free(dpf_vector, data, size, modified):
        errorSize = ctypes.c_int(0)
        sError = ctypes.c_wchar_p()
        res = capi.dll.DpfVector_char_free(
            dpf_vector._internal_obj,
    ...
    def dpf_vector_int_free(dpf_vector, data, size, modified):
        errorSize = ctypes.c_int(0)
        sError = ctypes.c_wchar_p()
        res = capi.dll.DpfVector_int_free(
            dpf_vector._internal_obj,
    ...
    def dpf_vector_char_ptr_free(dpf_vector, data, size, modified):
        errorSize = ctypes.c_int(0)
        sError = ctypes.c_wchar_p()
        res = capi.dll.DpfVector_char_ptr_free(
            dpf_vector._internal_obj,
    ...
    def dpf_vector_double_commit(dpf_vector, data, size, modified):
        errorSize = ctypes.c_int(0)
        sError = ctypes.c_wchar_p()
        res = capi.dll.DpfVector_double_commit(
            dpf_vector._internal_obj,
    ...
    def dpf_vector_int_commit(dpf_vector, data, size, modified):
        errorSize = ctypes.c_int(0)
        sError = ctypes.c_wchar_p()
        res = capi.dll.DpfVector_int_commit(
            dpf_vector._internal_obj,
    ...
    def dpf_vector_char_commit(dpf_vector, data, size, modified):
        errorSize = ctypes.c_int(0)
        sError = ctypes.c_wchar_p()
        res = capi.dll.DpfVector_char_commit(
            dpf_vector._internal_obj,
    ...
    def dpf_vector_char_ptr_commit(dpf_vector, data, size, modified):
        errorSize = ctypes.c_int(0)
        sError = ctypes.c_wchar_p()
        res = capi.dll.DpfVector_char_ptr_commit(
            dpf_vector._internal_obj,
            utils.to_char_ptr_ptr(data),
            utils.to_int32(size),
            modified,
    ...
    def dpf_vector_delete(dpf_vector):
        errorSize = ctypes.c_int(0)
        sError = ctypes.c_wchar_p()
        res = capi.dll.DpfVector_delete(
            dpf_vector._internal_obj, ctypes.byref(utils.to_int32(errorSize)), ctypes.byref(sError)
        )
        if errorSize.value != 0:
            raise errors.DPFServerException(sError.value)
        return res
    ...
    def dpf_vector_new_for_object(api_to_use):
        errorSize = ctypes.c_int(0)
        sError = ctypes.c_wchar_p()
        res = capi.dll.DpfVector_new_for_object(
    ...
    def dpf_string_free_for_object(api_to_use, dpf_vector, data, size):
        errorSize = ctypes.c_int(0)
        sError = ctypes.c_wchar_p()
        res = capi.dll.DpfString_free_for_object(
            api_to_use._internal_obj if api_to_use is not None else None,
            dpf_vector,
            utils.to_char_ptr(data),
            utils.to_int32(size),
