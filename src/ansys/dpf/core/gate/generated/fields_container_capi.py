...
from ansys.dpf.core.gate.generated import fields_container_abstract_api
...
class FieldsContainerCAPI(fields_container_abstract_api.FieldsContainerAbstractAPI):
    ...
    def fields_container_new():
        ...
        res = capi.dll.FieldsContainer_new(
    ...
    def fields_container_delete(fieldContainer):
        errorSize = ctypes.c_int(0)
        sError = ctypes.c_wchar_p()
        res = capi.dll.FieldsContainer_Delete(
            fieldContainer._internal_obj if fieldContainer is not None else None,
    ...
    def fields_container_at(fieldContainer, i, ic):
        errorSize = ctypes.c_int(0)
        sError = ctypes.c_wchar_p()
        res = capi.dll.FieldsContainer_at(
            fieldContainer._internal_obj if fieldContainer is not None else None,
            utils.to_int32(i),
            utils.to_int32(ic),
            ctypes.byref(utils.to_int32(errorSize)),
    ...
    def fields_container_set_field(fieldContainer, field, fieldId, ic):
        errorSize = ctypes.c_int(0)
        sError = ctypes.c_wchar_p()
        res = capi.dll.FieldsContainer_setField(
            fieldContainer._internal_obj if fieldContainer is not None else None,
            field._internal_obj if field is not None else None,
            utils.to_int32(fieldId),
            utils.to_int32(ic),
            ctypes.byref(utils.to_int32(errorSize)),
            ctypes.byref(sError),
        )
    ...
    def fields_container_get_scoping(fieldContainer, ic, size):
        errorSize = ctypes.c_int(0)
        sError = ctypes.c_wchar_p()
        res = capi.dll.FieldsContainer_GetScoping(
            fieldContainer._internal_obj if fieldContainer is not None else None,
            utils.to_int32(ic),
    ...
    def fields_container_num_fields(fieldContainer):
        errorSize = ctypes.c_int(0)
        sError = ctypes.c_wchar_p()
        res = capi.dll.FieldsContainer_numFields(
            fieldContainer._internal_obj if fieldContainer is not None else None,
            ctypes.byref(utils.to_int32(errorSize)),
            ctypes.byref(sError),
        )
