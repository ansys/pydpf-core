...
from ansys.dpf.core.gate.generated import external_data_abstract_api
...
class ExternalDataCAPI(external_data_abstract_api.ExternalDataAbstractAPI):
    ...
    def external_data_get(external_data):
        res = capi.dll.ExternalData_get(
            external_data._internal_obj if external_data is not None else None
        )
        return res
