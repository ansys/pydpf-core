...
class MeshedRegionGRPCAPI(meshed_region_abstract_api.MeshedRegionAbstractAPI):
    ...
    def init_meshed_region_environment(obj):
        from ansys.dpf.core.grpc.dpf import meshed_region_pb2_grpc
    ...
    def meshed_region_new_on_client(client):
        from ansys.dpf.core.grpc.dpf import meshed_region_pb2
    ...
    def meshed_region_get_shared_nodes_scoping(meshedRegion):
        from ansys.dpf.core.grpc.dpf import meshed_region_pb2
        from ansys.dpf.core.gate.common import locations
    ...
    def meshed_region_get_has_solid_region(meshedRegion):
        return MeshedRegionGRPCAPI.list(meshedRegion).element_shape_info.has_solid_elements

    @staticmethod
    def meshed_region_get_has_shell_region(meshedRegion):
        return MeshedRegionGRPCAPI.list(meshedRegion).element_shape_info.has_shell_elements

    @staticmethod
    def meshed_region_get_has_point_region(meshedRegion):
        return MeshedRegionGRPCAPI.list(meshedRegion).element_shape_info.has_point_elements

    @staticmethod
    def meshed_region_get_has_beam_region(meshedRegion):
        return MeshedRegionGRPCAPI.list(meshedRegion).element_shape_info.has_beam_elements
    ...
    def meshed_region_get_element_type(meshedRegion, id, type, index):
        from ansys.dpf.core.grpc.dpf import meshed_region_pb2
        from ansys.dpf.core.gate.common import elemental_property_type_dict
    ...
    def meshed_region_get_property_field(meshedRegion, property_type):
        ...
        if hasattr(request, "property_type"):
            ...
            from ansys.dpf.core.gate.common import nodal_property_type_dict, elemental_property_type_dict
    ...
    def meshed_region_get_coordinates_field(meshedRegion):
        return MeshedRegionGRPCAPI.meshed_region_get_property_field(meshedRegion, "coordinates")

    @staticmethod
    def meshed_region_set_coordinates_field(meshedRegion, field):
        return MeshedRegionGRPCAPI.meshed_region_set_property_field(
            meshedRegion, "coordinates", field
        )
