...
from ansys.dpf.core.gate import errors, field_grpcapi, grpc_stream_helpers
...
class CustomTypeFieldGRPCAPI(custom_type_field_abstract_api.CustomTypeFieldAbstractAPI):
    ...
    def cscustom_type_field_get_type(field, type, unitarySize):
        type.set(field._internal_obj.custom_type_def.unitary_datatype)
        unitarySize.set(field._internal_obj.custom_type_def.num_bytes_unitary_data)
