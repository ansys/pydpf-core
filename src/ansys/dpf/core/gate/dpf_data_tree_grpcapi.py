...
class DpfDataTreeGRPCAPI(dpf_data_tree_abstract_api.DpfDataTreeAbstractAPI):
    ...
    def init_dpf_data_tree_environment(object):
        from ansys.dpf.core.grpc.dpf import data_tree_pb2_grpc
        ...
        object._deleter_func = (
            _get_stub(object._server).Delete,
            lambda obj: obj._internal_obj
            if not isinstance(obj._internal_obj, (dict, list))
            else None,
        )
    ...
    def _dpf_data_tree_get_attribute(data_tree, attribute_name, value, type):
        if isinstance(data_tree._internal_obj, dict):
            ...
            return
        from ansys.dpf.core.grpc.dpf import data_tree_pb2, base_pb2
    ...
    def _set_attribute_init(data_tree, attribute_name):
        if isinstance(data_tree._internal_obj, dict):
            ...
            from ansys.dpf.core.grpc.dpf import data_tree_pb2
