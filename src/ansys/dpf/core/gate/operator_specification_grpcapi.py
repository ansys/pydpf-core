...
class OperatorSpecificationGRPCAPI(
    ...
    def operator_specification_new_on_client(client, op_name):
        from ansys.dpf.core.gate.operator_grpcapi import _get_stub as _get_operator_stub
        ...
        if hasattr(op_name, "_internal_obj"):
            ...
            from ansys.dpf.core.gate import operator_grpcapi, object_handler, data_processing_grpcapi
