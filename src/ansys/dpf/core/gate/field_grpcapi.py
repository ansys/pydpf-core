...
from ansys.dpf.core.gate import grpc_stream_helpers, errors
...
class FieldGRPCAPI(field_abstract_api.FieldAbstractAPI):
    ...
    def init_field_environment(object):
        from ansys.dpf.core.grpc.dpf import field_pb2_grpc
    ...
    def field_new_with1_ddimensionnality_on_client(
        ...
        from ansys.dpf.core.grpc.dpf import field_pb2
    ...
    def csfield_get_number_elementary_data(field):
        from ansys.dpf.core.grpc.dpf import base_pb2, field_pb2
    ...
    def csfield_get_data_size(field):
        ...
        if field._server.meet_version("4.0"):
            ...
            return FieldGRPCAPI.csfield_get_number_of_components(
                field
    ...
    def csfield_get_support_as_meshed_region(field):
        from ansys.dpf.core.grpc.dpf import field_pb2, base_pb2, meshed_region_pb2
    ...
    def csfield_get_support(field):
        from ansys.dpf.core.grpc.dpf import field_pb2, base_pb2
        ...
        try:
            ...
            raise RuntimeError("Could not get the field's support.")
    ...
    def csfield_get_name(field):
        from ansys.dpf.core.grpc.dpf import field_pb2
        from ansys.dpf.core.gate import data_processing_grpcapi
