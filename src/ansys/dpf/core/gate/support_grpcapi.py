from ansys.dpf.core.gate import errors, object_handler, data_processing_grpcapi
...
class SupportGRPCAPI(support_abstract_api.SupportAbstractAPI):
    ...
    def init_support_environment(object):
        from ansys.dpf.core.grpc.dpf import support_service_pb2_grpc
        ...
        if object._server.meet_version("4.0"):
            object._deleter_func = (
                data_processing_grpcapi._get_stub(object._server).Delete,
                lambda obj: obj._internal_obj,
            )
        else:
            ...
            object._deleter_func = (
                scoping_grpcapi._get_stub(object._server).Delete,
                lambda obj: obj._internal_obj,
            )

    @staticmethod
    def support_get_as_time_freq_support(support):
        from ansys.dpf.core.grpc.dpf import support_pb2, time_freq_support_pb2
    ...
    def support_get_as_meshed_support(support):
        from ansys.dpf.core.grpc.dpf import support_pb2, meshed_region_pb2
    ...
    def support_get_field_support_by_property(support, prop_name):
        from ansys.dpf.core.grpc.dpf import support_service_pb2
