...
from ansys.dpf.core.gate.operator_grpcapi import OperatorGRPCAPI
...
class WorkflowGRPCAPI(workflow_abstract_api.WorkflowAbstractAPI):
    ...
    def init_workflow_environment(object):
        from ansys.dpf.core.grpc.dpf import workflow_pb2_grpc
    ...
    def work_flow_new_on_client(client):
        from ansys.dpf.core.grpc.dpf import base_pb2, workflow_pb2
    ...
    def work_flow_get_copy_on_other_client(wf, address, protocol):
        from ansys.dpf.core.grpc.dpf import workflow_pb2
