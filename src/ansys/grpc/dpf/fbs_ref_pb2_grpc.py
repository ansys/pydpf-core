...
if _version_not_supported:
    raise RuntimeError(
        ...
        + ' but the generated code in fbs_ref_pb2_grpc.py depends on'
...
def add_FbsRefServiceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('ansys.api.dpf.fbs_ref.v0.FbsRefService', rpc_method_handlers)
...
def add_FbsClientServiceServicer_to_server(servicer, server):
    ...
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('ansys.api.dpf.fbs_ref.v0.FbsClientService', rpc_method_handlers)
