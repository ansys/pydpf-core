...
|                    |                        || (*Ansys 2022 R2*)               |                                  |
+--------------------+------------------------+----------------------------------+----------------------------------+
|                    || *CFF restart files*   || **7.0** and later               | :ref:`ref_fluids_model`          |
|                    || .cas/dat.h5           || (*Ansys 2024 R1 pre0*)          +----------------------------------+
|                    |                        |                                  | :ref:`ref_fluids_mesh`           |
|        Fluent      +------------------------+                                  +----------------------------------+
|                    || *Project files*       |                                  | :ref:`ref_fluids_results`        |
|                    || .flprj                |                                  |                                  |
+--------------------+------------------------+----------------------------------+----------------------------------+
|                    || *CFF files*           || **7.0** and later               | :ref:`ref_fluids_model`          |
|                    || .cas/dat.cff          || (*Ansys 2024 R1 pre0*)          +----------------------------------+
|                    |                        |                                  | :ref:`ref_fluids_mesh`           |
|          CFX       +------------------------+                                  +----------------------------------+
|                    || *Project files*       |                                  | :ref:`ref_fluids_results`        |
|                    || .flprj                |                                  |                                  |
