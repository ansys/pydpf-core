...
"""Operators from /shared/home1/cbellot/ansys_inc/v212/aisol/dll/linx64/libAns.Dpf.FEMutils.so plugin, from "mesh" category
"""
...
"""Operators from /shared/home1/cbellot/ansys_inc/v212/aisol/dll/linx64/libAns.Dpf.Native.so plugin, from "mesh" category
"""
    ...
    def _spec():
        spec = Specification(description="""Read a mesh from result files and cure degenerated elements""",
                             map_input_pin_spec={
                                 ...
                                 14 : PinSpecification(name = "read_cyclic", type_names=["N14dataProcessing14ECyclicReadingE","int32"], optional=True, document="""if 1 cyclic symmetry is ignored, if 2 cyclic expansion is done (default is 1)""")},
                             map_output_pin_spec={
                                 0 : PinSpecification(name = "mesh", type_names=["abstract_meshed_region"], optional=False, document="""""")})
        return spec
...
"""Operators from /shared/home1/cbellot/ansys_inc/v212/aisol/dll/linx64/libmeshOperatorsCore.so plugin, from "mesh" category
"""
