...
"""Operators from /shared/home1/cbellot/ansys_inc/v212/aisol/dll/linx64/libAns.Dpf.FEMutils.so plugin, from "result" category
"""
...
"""Operators from /shared/home1/cbellot/ansys_inc/v212/aisol/dll/linx64/libAns.Dpf.Native.so plugin, from "result" category
"""
...
class stress_von_mises(Operator):
    """Reads/computes element nodal component stresses, average it on nodes and computes its invariants.
    ...
    @staticmethod
    def _spec():
        spec = Specification(description="""Reads/computes element nodal component stresses, average it on nodes and computes its invariants.""",
                             map_input_pin_spec={
                                 ...
                                 14 : PinSpecification(name = "read_cyclic", type_names=["N14dataProcessing14ECyclicReadingE","int32"], optional=True, document="""if 0 cyclic symmetry is ignored, if 1 cyclic sector is read, if 2 cyclic expansion is done, if 3 cyclic expansion is done and stages are merged (default is 1)""")},
                             map_output_pin_spec={
                                 0 : PinSpecification(name = "fields_container", type_names=["fields_container"], optional=False, document="""""")})
        return spec
...
"""Operators from /shared/home1/cbellot/ansys_inc/v212/aisol/dll/linx64/libmapdlOperatorsCore.so plugin, from "result" category
"""
    ...
    def _spec():
        spec = Specification(description="""read Euler angles on elements from the rst file and rotate the fields in the fieldsContainer.""",
                             map_input_pin_spec={
                                 ...
                                 3 : PinSpecification(name = "streams_container", type_names=["streams_container","stream","N14dataProcessing15CRstFileWrapperE"], optional=True, document=""""""), 
                                 4 : PinSpecification(name = "data_sources", type_names=["data_sources"], optional=False, document="""""")},
                             map_output_pin_spec={
                                 0 : PinSpecification(name = "fields_container", type_names=["fields_container"], optional=False, document="""""")})
        return spec
...
"""Operators from /shared/home1/cbellot/ansys_inc/v212/aisol/dll/linx64/libmeshOperatorsCore.so plugin, from "result" category
"""

#internal name: vtk::vtk::FieldProvider
#scripting name: to_field
class _InputsToField(_Inputs):
    def __init__(self, op: Operator):
        super().__init__(to_field._spec().inputs, op)
        self.streams = Input(to_field._spec().input_pin(3), 3, op, -1) 
        self._inputs.append(self.streams)
        self.data_sources = Input(to_field._spec().input_pin(4), 4, op, -1) 
        self._inputs.append(self.data_sources)

class _OutputsToField(_Outputs):
    def __init__(self, op: Operator):
        super().__init__(to_field._spec().outputs, op)
        self.fields_container = Output(to_field._spec().output_pin(0), 0, op) 
        self._outputs.append(self.fields_container)

class to_field(Operator):
    ...
    def __init__(self, streams=None, data_sources=None, config=None, server=None):
        ...
        self.inputs = _InputsToField(self)
        self.outputs = _OutputsToField(self)
        if streams !=None:
    ...
    def _spec():
        spec = Specification(description="""Write a field based on a vtk file.""",
                             map_input_pin_spec={
                                 3 : PinSpecification(name = "streams", type_names=["streams_container"], optional=True, document="""streams"""), 
                                 4 : PinSpecification(name = "data_sources", type_names=["data_sources"], optional=True, document="""data_sources""")},
                             map_output_pin_spec={
                                 0 : PinSpecification(name = "fields_container", type_names=["fields_container"], optional=False, document="""fields_container""")})
        return spec
