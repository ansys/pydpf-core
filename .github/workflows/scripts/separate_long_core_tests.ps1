...
New-Item -Path ".\" -Name "test_incremental" -ItemType "directory"
...
Copy-Item -Path "tests\conftest.py" -Destination ".\test_incremental\"
...
Copy-Item -Path "tests\test_incremental.py" -Destination ".\test_incremental\"
...
Remove-Item -Path "tests\test_incremental.py"