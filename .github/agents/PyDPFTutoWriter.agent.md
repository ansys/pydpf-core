...
# PyDPFTutoWriter â€” PyDPF-Core Tutorial Specialist
...
### Step 3 â€” Survey the target section
...
### Step 5 â€” Write the tutorial Python file
...
<One sentence goal â€” this is also the card description.>
...
# ------------------
#
# <Prose explanation (full RST, 1â€“4 sentences).>
...
- **Titles use sentence case** â€” capitalize only the first word and proper nouns
...
- The section separator is exactly 79 characters: `#` Ã— 79.
...
- Variable names must not clash with DPF class names or argument names.
  Use `my_model`, `ds`, `result_fc`, `stress_fc` â€” never `model`, `data_sources`, `result`.
...
### Step 6 â€” Update GALLERY_HEADER.rst
