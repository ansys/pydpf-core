...
def all_kind_of_complexity_models():
    ...
    server.LOG.debug("before all_kind_of_complexity_models", dpf.SERVER, local_server.info)
    otherfile = dpf.upload_file_in_tmp_folder(
...
def test_model_different_results_big_multi_server(all_kind_of_complexity_models):
    ...
    server.LOG.debug("after all_kind_of_complexity_models", dpf.SERVER, local_server.info)
