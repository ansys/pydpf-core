...
@pytest.mark.skipif(platform.system() is "Windows" and platform.python_version().startswith("3.10"),
                    reason="Known failure in the GitHub pipeline for 3.10 on Windows")
@pytest.mark.xfail(raises=dpf.core.errors.ServerTypeError)
@conftest.raises_for_servers_version_under('3.0')
