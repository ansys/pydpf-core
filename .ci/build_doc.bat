...
xcopy  source/examples/12-fluids/02-fluids_results/sphx_glr_02-fluids_results_00_thumb.png                build/html/_images/sphx_glr_02-fluids_results_00_thumb.png     /y
